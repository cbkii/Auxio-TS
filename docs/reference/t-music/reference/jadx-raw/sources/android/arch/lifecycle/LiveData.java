...
public abstract class LiveData<T> {
    ...
    public void dispatchingValue(@Nullable LiveData<T>.AbstractC0010b abstractC0010b) {
        ...
        do {
            ...
            if (abstractC0010b != null) {
                ...
                C0008c<InterfaceC0024m<? super T>, LiveData<T>.AbstractC0010b>.d m16va = this.mObservers.m16va();
                while (m16va.hasNext()) {
                    considerNotify((AbstractC0010b) m16va.next().getValue());
    ...
    public void observe(@NonNull InterfaceC0016e interfaceC0016e, @NonNull InterfaceC0024m<? super T> interfaceC0024m) {
        ...
        LiveData<T>.AbstractC0010b putIfAbsent = this.mObservers.putIfAbsent(interfaceC0024m, lifecycleBoundObserver);
        if (putIfAbsent != null && !putIfAbsent.mo30g(interfaceC0016e)) {
    ...
    public void observeForever(@NonNull InterfaceC0024m<? super T> interfaceC0024m) {
        ...
        LiveData<T>.AbstractC0010b putIfAbsent = this.mObservers.putIfAbsent(interfaceC0024m, c0009a);
    ...
    public void removeObserver(@NonNull InterfaceC0024m<? super T> interfaceC0024m) {
        ...
        LiveData<T>.AbstractC0010b remove = this.mObservers.remove(interfaceC0024m);
        if (remove == null) {
            return;
        }
        remove.mo31xa();
    ...
    public void removeObservers(@NonNull InterfaceC0016e interfaceC0016e) {
        ...
        Iterator<Map.Entry<InterfaceC0024m<? super T>, LiveData<T>.AbstractC0010b>> it = this.mObservers.iterator();
        while (it.hasNext()) {
            Map.Entry<InterfaceC0024m<? super T>, LiveData<T>.AbstractC0010b> next = it.next();
            if (next.getValue().mo30g(interfaceC0016e)) {
