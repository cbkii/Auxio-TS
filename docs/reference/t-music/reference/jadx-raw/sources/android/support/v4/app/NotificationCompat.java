...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            int min;
            boolean z2 = true;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, C0031R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(C0031R.id.actions);
            if (!z || (arrayList = this.mBuilder.mActions) == null || (min = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < min; i++) {
                    applyStandardTemplate.addView(C0031R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            applyStandardTemplate.setViewVisibility(C0031R.id.actions, i2);
            applyStandardTemplate.setViewVisibility(C0031R.id.action_divider, i2);
    ...
    public static abstract class Style {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0031R.id.title, charSequence3);
            }
            CharSequence charSequence4 = this.mBuilder.mContentText;
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0031R.id.text, charSequence4);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (charSequence5 != null) {
                remoteViews.setTextViewText(C0031R.id.info, charSequence5);
                ...
                if (builder4.mNumber <= 0) {
                    ...
                    if (charSequence != null && Build.VERSION.SDK_INT >= 16) {
                        ...
                        if (charSequence2 == null) {
                            remoteViews.setTextViewText(C0031R.id.text2, charSequence2);
