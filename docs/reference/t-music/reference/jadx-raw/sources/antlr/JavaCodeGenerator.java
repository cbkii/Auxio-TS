...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x0128 A[Catch: all -> 0x0130, TRY_LEAVE, TryCatch #0 {all -> 0x0130, blocks: (B:3:0x0002, B:6:0x0038, B:9:0x0040, B:10:0x0047, B:12:0x004f, B:14:0x0053, B:16:0x0056, B:18:0x0063, B:20:0x0067, B:21:0x006a, B:23:0x0078, B:25:0x008a, B:27:0x00c2, B:29:0x00cb, B:30:0x00ef, B:31:0x011a, B:32:0x011d, B:34:0x0128, B:39:0x008e, B:40:0x00f4, B:42:0x00fa), top: B:2:0x0002 }] */
    /*
    ...
    */
        ...
        try {
            ...
            if ((this.grammar instanceof TreeWalkerGrammar) && !this.grammar.buildAST) {
                if (alternativeElement.getLabel() == null) {
                    ...
                    String str5 = "tmp" + this.astVarNumber + "_AST";
                    this.astVarNumber++;
                    mapTreeVariable(alternativeElement, str5);
                    println(this.labeledElementASTType + " " + str5 + "_in = " + str4 + ";");
                }
                return;
            }
                ...
                if (z) {
                    if (alternativeElement instanceof GrammarAtom) {
                        ...
                        if (grammarAtom.getASTNodeType() != null) {
                            ...
                            genASTDeclaration(alternativeElement, str2, str3);
                        }
                    }
                    str3 = this.labeledElementASTType;
                    genASTDeclaration(alternativeElement, str2, str3);
                }
                String str6 = str2 + "_AST";
                mapTreeVariable(alternativeElement, str6);
                if (this.grammar instanceof TreeWalkerGrammar) {
                    println(this.labeledElementASTType + " " + str6 + "_in = null;");
                }
                if (alternativeElement.getLabel() != null) {
                    if (alternativeElement instanceof GrammarAtom) {
                        ...
                        sb3.append(str6);
                        sb3.append(" = ");
                        sb3.append(getASTCreateString((GrammarAtom) alternativeElement, str));
                        sb3.append(";");
                    } else {
                        sb3 = new StringBuilder();
                        sb3.append(str6);
                        sb3.append(" = ");
                        sb3.append(getASTCreateString(str));
                        sb3.append(";");
                    }
                    println(sb3.toString());
                }
                if (alternativeElement.getLabel() == null && z) {
                    String str7 = this.lt1Value;
                    if (alternativeElement instanceof GrammarAtom) {
                        sb2 = new StringBuilder();
                        sb2.append(str6);
                        sb2.append(" = ");
                        sb2.append(getASTCreateString((GrammarAtom) alternativeElement, str7));
                        sb2.append(";");
                    } else {
                        sb2 = new StringBuilder();
                        sb2.append(str6);
                        sb2.append(" = ");
                        sb2.append(getASTCreateString(str7));
                        sb2.append(";");
                    }
                    println(sb2.toString());
                    if (this.grammar instanceof TreeWalkerGrammar) {
                        println(str6 + "_in = " + str7 + ";");
                    }
                }
                if (this.genAST) {
    ...
    public void gen(LexerGrammar lexerGrammar) {
        ...
        try {
            ...
            try {
                ...
                if (token == null || (str2 = StringUtils.stripFrontBack(token.getText(), "\"", "\"")) == null) {
                    str2 = "public";
                }
                print(str2 + " ");
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x00fe A[Catch: all -> 0x01a3, TRY_ENTER, TryCatch #0 {all -> 0x01a3, blocks: (B:3:0x0004, B:5:0x000e, B:6:0x0029, B:8:0x0039, B:9:0x005a, B:11:0x007d, B:12:0x0095, B:14:0x00bf, B:15:0x00c5, B:17:0x00d5, B:19:0x00dd, B:21:0x00e7, B:25:0x00fe, B:27:0x0102, B:28:0x011a, B:29:0x014e, B:34:0x00ea, B:36:0x00ee, B:40:0x0082, B:41:0x004b), top: B:2:0x0004 }] */
    @Override // antlr.CodeGenerator
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void gen(OneOrMoreBlock oneOrMoreBlock) {
        ...
        try {
            ...
            println("int " + sb2 + "=0;");
            if (oneOrMoreBlock.getLabel() != null) {
                str = oneOrMoreBlock.getLabel();
            } else {
                str = "_loop" + oneOrMoreBlock.f302ID;
            }
            println(str + ":");
            println("do {");
            this.tabs = this.tabs + 1;
            ...
            if (!oneOrMoreBlock.greedy && (i2 = oneOrMoreBlock.exitLookaheadDepth) <= this.grammar.maxk && oneOrMoreBlock.exitCache[i2].containsEpsilon()) {
                ...
                if (z) {
                    ...
                    println("if ( " + sb2 + ">=1 && " + lookaheadTestExpression + ") break " + str + ";", CONTINUE_LAST_MAPPING);
                }
                genBlockFinish(genCommonBlock(oneOrMoreBlock, false), "if ( " + sb2 + ">=1 ) { break " + str + "; } else {" + this.throwNoViable + "}", oneOrMoreBlock.getLine());
    ...
    public void gen(TokenRangeElement tokenRangeElement) {
        ...
        m5a.append(",");
        println(C0000a.m3a(m5a, tokenRangeElement.endText, ");"), tokenRangeElement.getLine());
    ...
    /* JADX WARN: Removed duplicated region for block: B:14:0x0099 A[Catch: all -> 0x00a1, TRY_LEAVE, TryCatch #0 {all -> 0x00a1, blocks: (B:3:0x0002, B:5:0x000e, B:7:0x0012, B:8:0x0034, B:11:0x003f, B:12:0x0093, B:14:0x0099, B:19:0x0043, B:21:0x0049, B:23:0x0050, B:25:0x0054, B:27:0x005a, B:28:0x005f, B:30:0x006a, B:32:0x006e, B:35:0x0077), top: B:2:0x0002 }] */
    @Override // antlr.CodeGenerator
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:22:0x00b6 A[Catch: all -> 0x012f, TRY_ENTER, TryCatch #0 {all -> 0x012f, blocks: (B:3:0x0002, B:5:0x000c, B:6:0x0027, B:8:0x0035, B:9:0x004d, B:11:0x0077, B:12:0x007d, B:14:0x008d, B:16:0x0095, B:18:0x009f, B:22:0x00b6, B:24:0x00ba, B:25:0x00d2, B:26:0x00fc, B:31:0x00a2, B:33:0x00a6, B:37:0x003a), top: B:2:0x0002 }] */
    @Override // antlr.CodeGenerator
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void gen(ZeroOrMoreBlock zeroOrMoreBlock) {
        ...
        try {
            ...
            if (zeroOrMoreBlock.getLabel() != null) {
                str = zeroOrMoreBlock.getLabel();
            } else {
                str = "_loop" + zeroOrMoreBlock.f302ID;
            }
            println(str + ":");
            println("do {");
            this.tabs = this.tabs + 1;
            ...
            if (!zeroOrMoreBlock.greedy && (i2 = zeroOrMoreBlock.exitLookaheadDepth) <= this.grammar.maxk && zeroOrMoreBlock.exitCache[i2].containsEpsilon()) {
                ...
                if (z) {
                    ...
                    println("if (" + lookaheadTestExpression + ") break " + str + ";");
                }
                genBlockFinish(genCommonBlock(zeroOrMoreBlock, false), "break " + str + ";", zeroOrMoreBlock.getLine());
                this.tabs = this.tabs - 1;
                println("} while (true);");
                println("}");
                this.currentASTResult = str2;
    ...
    public JavaBlockFinishingInfo genCommonBlock(AlternativeBlock alternativeBlock, boolean z) {
        ...
        try {
            ...
            if (alternativeBlock.not && this.analyzer.subruleCanBeInverted(alternativeBlock, this.grammar instanceof LexerGrammar)) {
                ...
                println("match(" + (this.grammar instanceof TreeWalkerGrammar ? "_t," : "") + getBitsetName(markBitsetForGen(look.fset)) + ");");
                if (this.grammar instanceof TreeWalkerGrammar) {
                    println("_t = _t.getNextSibling();");
                }
                ...
                while (i15 < alternativeBlock.alternatives.size()) {
                    ...
                    if (!z2 || !suitableForCaseExpression(alternativeAt3)) {
                        if (this.grammar instanceof LexerGrammar) {
                            ...
                            if (i4 == i11) {
                                lookaheadIsEmpty = lookaheadIsEmpty(alternativeAt3, i4);
                        ...
                        try {
                            ...
                            if (alternativeAt3.cache[1].fset.degree() <= 127 || !suitableForCaseExpression(alternativeAt3)) {
                                if (lookaheadIsEmpty && alternativeAt3.semPred == null && alternativeAt3.synPred == null) {
                                    ...
                                    if (alternativeAt3.semPred != null) {
                                        ...
                                        if (((this.grammar instanceof ParserGrammar) || (this.grammar instanceof LexerGrammar)) && this.grammar.debuggingOutput) {
                                            sb3 = new StringBuilder();
                                            sb3.append("(");
                                            sb3.append(lookaheadTestExpression);
                                            sb3.append("&& fireSemanticPredicateEvaluated(antlr.debug.SemanticPredicateEvent.PREDICTING,");
                                            sb3.append(addSemPred(this.charFormatter.escapeString(processActionForSpecialSymbols)));
                                            sb3.append(",");
                                            sb3.append(processActionForSpecialSymbols);
                                        } else {
                                            sb3 = new StringBuilder();
                                            sb3.append("(");
                                            sb3.append(lookaheadTestExpression);
                                        ...
                                        sb3.append("))");
                                        lookaheadTestExpression = sb3.toString();
                                    } else {
                                        javaBlockFinishingInfo2 = javaBlockFinishingInfo3;
                                        str3 = str6;
                                    }
                                ...
                                sb2 = i14 == 0 ? "if " + lookaheadTestExpression + " {" : "else if " + lookaheadTestExpression + " {";
                                javaBlockFinishingInfo2 = javaBlockFinishingInfo3;
                                str3 = str6;
                            }
                            println(sb2);
    ...
    public void genHeader() {
        ...
        m5a.append(".java\"$");
        println(m5a.toString(), NO_MAPPING);
    }
    ...
    public void genMatchUsingAtomTokenType(GrammarAtom grammarAtom) {
        ...
        sb2.append(sb);
        sb2.append(");");
        println(sb2.toString(), grammarAtom.getLine());
    }
    ...
    public void genNextToken() {
        ...
        try {
            ...
            genBlockFinish(genCommonBlock, sb.toString(), createNextTokenRule.getLine());
    ...
    /* JADX WARN: Removed duplicated region for block: B:106:0x0357 A[Catch: all -> 0x052f, TryCatch #1 {all -> 0x052f, blocks: (B:99:0x0303, B:100:0x0323, B:103:0x0346, B:106:0x0357, B:107:0x03f3, B:109:0x03f9, B:110:0x0416, B:112:0x041c, B:113:0x0421, B:115:0x0427, B:117:0x0431, B:118:0x0435, B:119:0x0438, B:121:0x043e, B:122:0x0455, B:124:0x0459, B:125:0x047e, B:127:0x0484, B:131:0x0519, B:135:0x048e, B:137:0x04a4, B:140:0x04ac, B:141:0x04cf, B:142:0x04bb, B:144:0x04c1, B:145:0x04d6, B:147:0x04dc, B:150:0x04e4, B:151:0x0509, B:152:0x04f7, B:153:0x0510, B:154:0x035c, B:156:0x0362, B:158:0x0389, B:159:0x0394, B:161:0x039f, B:162:0x03ca, B:163:0x03d1, B:165:0x03d7, B:166:0x03ea, B:168:0x034c, B:171:0x0327), top: B:90:0x02e7 }] */
    /* JADX WARN: Removed duplicated region for block: B
cd, B:55:0x01bb, B:56:0x01d4, B:58:0x01da, B:61:0x01e8, B:62:0x0209, B:63:0x01ec, B:64:0x020e, B:67:0x0218, B:70:0x0220, B:71:0x0243, B:72:0x022f, B:74:0x0235, B:75:0x024a, B:77:0x0250, B:79:0x0260, B:81:0x0266, B:82:0x0292, B:84:0x0298, B:85:0x02c2, B:87:0x02d1, B:89:0x02e1, B:92:0x02e9, B:94:0x02f2, B:95:0x02f9, B:97:0x02fd, B:176:0x02d7, B:177:0x0256, B:178:0x012b, B:181:0x0106), top: B:10:0x004b }] */
    /* JADX WARN: Removed duplicated region for block: B:92:0x02e9 A[Catch: all -> 0x0533, TryCatch #0 {all -> 0x0533, blocks: (B:11:0x004b, B:13:0x0064, B:16:0x006d, B:18:0x0079, B:19:0x007c, B:22:0x0098, B:23:0x00b5, B:24:0x00bc, B:26:0x00e1, B:28:0x00e5, B:29:0x00ea, B:32:0x00f0, B:33:0x0109, B:36:0x0127, B:37:0x0134, B:39:0x0138, B:41:0x013e, B:42:0x0157, B:43:0x016d, B:46:0x017d, B:47:0x0191, B:50:0x01a0, B:53:0x01a8, B:54:0x01cd, B:55:0x01bb, B:56:0x01d4, B:58:0x01da, B:61:0x01e8, B:62:0x0209, B:63:0x01ec, B:64:0x020e, B:67:0x0218, B:70:0x0220, B:71:0x0243, B:72:0x022f, B:74:0x0235, B:75:0x024a, B:77:0x0250, B:79:0x0260, B:81:0x0266, B:82:0x0292, B:84:0x0298, B:85:0x02c2, B:87:0x02d1, B:89:0x02e1, B:92:0x02e9, B:94:0x02f2, B:95:0x02f9, B:97:0x02fd, B:176:0x02d7, B:177:0x0256, B:178:0x012b, B:181:0x0106), top: B:10:0x004b }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public void genRule(RuleSymbol ruleSymbol, boolean z, int i) {
        ...
        if (this.DEBUG_CODE_GENERATOR) {
            PrintStream printStream = System.out;
            StringBuilder m5a = C0000a.m5a("genRule(");
    ...
    public void genSemPred(String str, int i) {
        ...
        println("if (!(" + processActionForSpecialSymbols + "))", i);
        println("  throw new SemanticException(\"" + escapeString + "\");", i);
    }

    public void genSemPredMap() {
        Enumeration elements = this.semPreds.elements();
        String str = "private String _semPredNames[] = {";
        while (true) {
            println(str, NO_MAPPING);
                    ...
                    if (str != null) {
                        if (str.startsWith("\"")) {
                            ...
                            if (stringLiteralSymbol == null) {
                                ...
                                sb2 = "int " + stringLiteralSymbol.label + " = " + i2 + ";";
                            } else {
                                String mangleLiteral = mangleLiteral(str);
                                if (mangleLiteral != null) {
                                    println("int " + mangleLiteral + " = " + i2 + ";");
    ...
    public String getASTCreateString(Vector vector) {
        ...
        m5a.append(")astFactory.make( (new ASTArray(");
        m5a.append(vector.size());
        m5a.append("))");
        stringBuffer.append(m5a.toString());
        for (int i = 0; i < vector.size(); i++) {
            StringBuilder m5a2 = C0000a.m5a(".add(");
