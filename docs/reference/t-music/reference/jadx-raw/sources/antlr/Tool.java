...
public class Tool {
    ...
    /* JADX WARN: Removed duplicated region for block: B:11:0x003d A[Catch: Exception -> 0x0046, TRY_LEAVE, TryCatch #0 {Exception -> 0x0046, blocks: (B:3:0x000b, B:8:0x0039, B:11:0x003d, B:14:0x0011, B:16:0x0014, B:18:0x001e, B:20:0x0028, B:22:0x0033), top: B:2:0x000b }] */
    /* JADX WARN: Removed duplicated region for block: B:8:0x0039 A[Catch: Exception -> 0x0046, TryCatch #0 {Exception -> 0x0046, blocks: (B:3:0x000b, B:8:0x0039, B:11:0x003d, B:14:0x0011, B:16:0x0014, B:18:0x001e, B:20:0x0028, B:22:0x0033), top: B:2:0x000b }] */
    /*
    ...
    */
    public static void main(String[] strArr) {
        ...
        try {
            ...
            StringBuilder m5a = C0000a.m5a("#$%%*&@# internal error: ");
            ...
            StringBuilder m5a2 = C0000a.m5a(" please send stack trace with report.]");
    ...
    public void checkForInvalidArguments(String[] strArr, BitSet bitSet) {
        for (int i = 0; i < strArr.length; i++) {
            if (!bitSet.member(i)) {
                StringBuilder m5a = C0000a.m5a("invalid command-line argument: ");
                m5a.append(strArr[i]);
                m5a.append("; ignored");
                warning(m5a.toString());
            }
        }
    }
    ...
    public int doEverything(String[] strArr) {
        ...
        try {
            ...
            fatalError(m5a.toString());
            return 0;
        } catch (TokenStreamException e2) {
            e = e2;
            str = "TokenStreamException: ";
            StringBuilder m5a2 = C0000a.m5a(str);
            m5a2.append(e.getMessage());
            fatalError(m5a2.toString());
            return 0;
        }
    }
    ...
    public Reader getGrammarReader() {
        try {
            ...
            StringBuilder m5a = C0000a.m5a("cannot open grammar file ");
            m5a.append(this.grammarFile);
            fatalError(m5a.toString());
        }
        return null;
    }
    ...
    public String pathToFile(String str) {
        ...
        m5a.append(System.getProperty("file.separator"));
        return m5a.toString();
    }
    ...
    public void reportException(Exception exc, String str) {
        ...
        if (str == null) {
            ...
            StringBuilder m9b = C0000a.m9b(str, ": ");
            m9b.append(exc.getMessage());
            sb = m9b.toString();
        }
