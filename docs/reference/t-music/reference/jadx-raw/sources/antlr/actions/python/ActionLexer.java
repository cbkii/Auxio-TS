...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:50:? A[FALL_THROUGH, SYNTHETIC] */
            ...
            if (mo105LA == '[') {
                ...
                switch (mo105LA) {
                    case '(':
                        ...
                        char mo105LA4 = mo105LA(1);
                        if (mo105LA4 != '\t' && mo105LA4 != '\n' && mo105LA4 != '\r' && mo105LA4 != ' ') {
                            if (mo105LA4 != '_' && mo105LA4 != '\"' && mo105LA4 != '#') {
                                switch (mo105LA4) {
                                    case '\'':
                                    case '(':
                                        break;
                                                        ...
                                                        while (true) {
                                                            ...
                                                            if (mo105LA(1) == ',') {
                                                                ...
                                                                if (mo105LA5 == '\t' || mo105LA5 == '\n' || mo105LA5 == '\r' || mo105LA5 == ' ') {
                                                                    ...
                                                                    mWS(false);
                                                                    this.text.setLength(length6);
                                                                } else if (mo105LA5 != '_' && mo105LA5 != '\"' && mo105LA5 != '#' && mo105LA5 != '\'' && mo105LA5 != '(') {
                                                                    switch (mo105LA5) {
                                                                        case '0':
                                                                        case '1':
                                                                        case '2':
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0040, code lost:
        ...
        if (antlr.actions.python.ActionLexer._tokenSet_25.member(mo105LA(2)) == false) goto L16;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:25:0x0058, code lost:
        ...
        if (antlr.actions.python.ActionLexer._tokenSet_25.member(mo105LA(2)) == false) goto L21;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x007c, code lost:
        ...
        if (antlr.actions.python.ActionLexer._tokenSet_25.member(mo105LA(2)) == false) goto L47;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:40:0x008c, code lost:
        ...
        if (antlr.actions.python.ActionLexer._tokenSet_25.member(mo105LA(1)) == false) goto L38;
     */
    ...
    */
    ...
    public final void mTEXT_ARG_ID_ELEMENT(boolean z) {
        ...
        char mo105LA = mo105LA(1);
        if (mo105LA != '\t' && mo105LA != '\n' && mo105LA != '\r' && mo105LA != ' ' && mo105LA != '\"' && mo105LA != '$') {
            if (mo105LA == '.') {
                match('.');
                mTEXT_ARG_ID_ELEMENT(false);
    ...
    public final void mTEXT_ITEM(boolean z) {
        ...
        if (mo105LA(1) == '$' && mo105LA(2) == 's' && mo105LA(3) == 'e') {
            ...
            if (mo105LA(1) == 'T' && mo105LA(2) == 'e') {
                ...
                sb3.append(str5);
                fIRSTBitSet = C0000a.m0a(token5, sb3);
                this.text.setLength(length);
                this.text.append(fIRSTBitSet);
            }
