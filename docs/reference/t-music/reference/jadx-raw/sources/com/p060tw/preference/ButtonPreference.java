...
public class ButtonPreference extends LinearLayout {
    ...
    /* renamed from: com.tw.preference.ButtonPreference$a */
    ...
    private void m1533a(AttributeSet attributeSet) {
        ...
        this.titleTextSize = obtainStyledAttributes.getDimension(R$styleable.ButtonPreference_android_textSize, getResources().getDimension(R$dimen.tw_dp_h32));
        ...
        this.f1215fe = obtainStyledAttributes.getDrawable(R$styleable.ButtonPreference_rightIconBackground);
        this.paddingLeft = (int) obtainStyledAttributes.getDimension(R$styleable.ButtonPreference_paddingLeft, getResources().getDimension(R$dimen.tw_dp_w64));
        this.paddingRight = (int) obtainStyledAttributes.getDimension(R$styleable.ButtonPreference_paddingRight, getResources().getDimension(R$dimen.tw_dp_w64));
        this.rightIconWidth = (int) obtainStyledAttributes.getDimension(R$styleable.ButtonPreference_rightIconWidth, getResources().getDimension(R$dimen.tw_dp_h150));
        this.rightIconHeight = (int) obtainStyledAttributes.getDimension(R$styleable.ButtonPreference_rightIconHeight, getResources().getDimension(R$dimen.tw_dp_h75));
