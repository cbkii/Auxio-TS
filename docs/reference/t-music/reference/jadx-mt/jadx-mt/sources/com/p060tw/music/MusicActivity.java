...
public class MusicActivity extends BaseMusicActivity implements View.OnLongClickListener {
    ...
    public void mo803d(int i, int i2) {
        ...
        int iM1329Ba = m1329Ba(i2);
        int iM1330Ca = m1330Ca(i2);
        int iM1331Da = m1331Da(i2);
        if (iM1329Ba == 0) {
            this.f1024Eb.setText(String.format(Locale.US, "%d:%02d", Integer.valueOf(iM1330Ca), Integer.valueOf(iM1331Da)));
        } else {
            this.f1024Eb.setText(String.format(Locale.US, "%d:%02d:%02d", Integer.valueOf(iM1329Ba), Integer.valueOf(iM1330Ca), Integer.valueOf(iM1331Da)));
        }
        int iM1329Ba2 = m1329Ba(i);
        int iM1330Ca2 = m1330Ca(i);
        int iM1331Da2 = m1331Da(i);
        if (iM1329Ba2 == 0) {
            this.f1023Db.setText(String.format(Locale.US, "%d:%02d", Integer.valueOf(iM1330Ca2), Integer.valueOf(iM1331Da2)));
        } else {
            this.f1023Db.setText(String.format(Locale.US, "%d:%02d:%02d", Integer.valueOf(iM1329Ba2), Integer.valueOf(iM1330Ca2), Integer.valueOf(iM1331Da2)));
        }
    }
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.repeat /* 2131230880 */:
                int iM1374hd = this.mService.f1072Pa.m1374hd() + 1;
                if (iM1374hd > 2) {
                    iM1374hd = 0;
                }
                ((C0635a) this.mPresenter).m733pa(iM1374hd);
                this.mService.f1072Pa.m1381va(iM1374hd);
                break;
