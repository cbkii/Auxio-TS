...
/* JADX INFO: renamed from: com.eckom.xtlibrary.twproject.activity.b */
...
class C0713b extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        if ("notify_theme_change".equals(intent.getAction())) {
            ...
            C0683m c0683mMo1104Ka = this.this$0.mo1104Ka();
            this.this$0.mo1106d(c0683mMo1104Ka);
            if (intExtra == 0) {
                if (c0683mMo1104Ka.f821em == 1) {
                    ...
                    if (new File(this.this$0.f864db.m936Dc()).exists()) {
                        C0678h.m961a(this.this$0.f864db.m936Dc(), c0683mMo1104Ka);
                    ...
                    if (new File(this.this$0.f864db.m942Ic()).exists()) {
                        C0678h.m961a(this.this$0.f864db.m942Ic(), c0683mMo1104Ka);
                        C0681k.get().m978e(c0683mMo1104Ka);
                        this.this$0.f866fb = true;
                    }
                }
            ...
            this.this$0.mo1105c(c0683mMo1104Ka);
        }
    }
}
