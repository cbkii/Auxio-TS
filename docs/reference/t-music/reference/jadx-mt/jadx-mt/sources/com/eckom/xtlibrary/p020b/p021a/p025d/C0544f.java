...
/* JADX INFO: renamed from: com.eckom.xtlibrary.b.a.d.f */
...
public class C0544f<P extends AbstractC0658a> extends AbstractC0546h implements C0532b.b {
    ...
    /* JADX INFO: renamed from: com.eckom.xtlibrary.b.a.d.f$a */
    /* JADX INFO: compiled from: BTModel.java */
    ...
    public void m220Pe() {
        ...
        for (int i = 0; i < strArrSplit.length - 2; i += 3) {
            TWContact tWContact = new TWContact(strArrSplit[i], strArrSplit[i + 1], strArrSplit[i + 2]);
    ...
    public void m263ub() {
        ...
        messageObtainMessage.what = 65287;
    ...
    public void m227b(int i, String str) {
        ...
        if ((i2 & 1) == 1) {
            ...
            this.f427wh.write(1296, (i << 4) | 0, bytes != null ? bytes.length : 0, bytes);
            return;
        }
        if ((i2 & 2) == 2) {
            try {
            ...
            this.f427wh.write(1296, (i << 4) | 1, bytes != null ? bytes.length : 0, bytes);
            return;
        }
        int i3 = 3;
        if ((i2 & 4) == 4) {
            ...
            if (bytes == null && (this.f424Eh & 128) == 128) {
                try {
                    bytes = str.getBytes("UTF-8");
            ...
            this.f427wh.write(1296, (i << 4) | i3, bytes != null ? bytes.length : 0, bytes);
            return;
        }
        if ((i2 & 8) == 8) {
            try {
