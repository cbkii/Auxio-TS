...
public class SingleChoosePreference extends LinearLayout {
    ...
    /* JADX INFO: renamed from: com.tw.preference.SingleChoosePreference$a */
    ...
    public void m1538Ia(int i) {
        ...
        int[] iArrM1543a = m1543a(this.f1230le, linearLayout);
        Log.d("SingleChoosePreferenceT", "showChooseList: " + Arrays.toString(iArrM1543a));
        int i3 = this.context.getResources().getDisplayMetrics().widthPixels;
        int i4 = iArr[0];
        iArrM1543a[0] = iArrM1543a[0] - (this.f1230le.getMeasuredWidth() / 2);
        this.f1233oe.showAtLocation(this.f1230le, 8388659, iArrM1543a[0], iArrM1543a[1]);
    ...
    private void initView(Context context) {
        ...
        int color = Color.parseColor("#919191");
    ...
    public void setCurrentEntry(String str) {
        int iM1550ua = m1550ua(str);
        if (iM1550ua != -1) {
            CharSequence[] charSequenceArr = this.mEntries;
            if (iM1550ua > charSequenceArr.length - 1) {
                return;
            }
            this.f1232ne = iM1550ua;
            this.f1229je.setText(charSequenceArr[iM1550ua]);
        }
    }
    ...
    public void setValue(String str) {
        int iFindIndexOfValue = findIndexOfValue(str);
        if (iFindIndexOfValue == -1) {
            return;
        }
        this.f1232ne = iFindIndexOfValue;
        this.f1229je.setText(m1537Ha(iFindIndexOfValue));
        this.mValue = str;
    }
    ...
    private void m1542a(AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = this.context.obtainStyledAttributes(attributeSet, R$styleable.SingleChoosePreference);
        this.itemBackground = typedArrayObtainStyledAttributes.getDrawable(R$styleable.SingleChoosePreference_android_background);
        this.title = typedArrayObtainStyledAttributes.getString(R$styleable.SingleChoosePreference_android_title);
        this.subTitle = typedArrayObtainStyledAttributes.getString(R$styleable.SingleChoosePreference_subTitle);
        this.summary = typedArrayObtainStyledAttributes.getString(R$styleable.SingleChoosePreference_android_summary);
        this.titleTextSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_titleTextSize, (int) this.context.getResources().getDimension(R$dimen.tw_dp_h32));
        this.subTitleTextSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_subTitleTextSize, (int) this.context.getResources().getDimension(R$dimen.tw_dp_h24));
        this.summaryTextSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_summaryTextSize, (int) this.context.getResources().getDimension(R$dimen.tw_dp_h28));
        this.titleTextColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SingleChoosePreference_titleTextColor, -1);
        this.subTitleTextColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SingleChoosePreference_subTitleTextColor, Color.parseColor("#919191"));
        this.summaryTextColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SingleChoosePreference_summaryTextColor, Color.parseColor("#919191"));
        this.f1226fe = typedArrayObtainStyledAttributes.getDrawable(R$styleable.SingleChoosePreference_rightIconBackground);
        this.popItemWidth = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_popItemWidth, (int) getResources().getDimension(R$dimen.tw_dp_w260));
        this.popItemHeight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_popItemHeight, (int) getResources().getDimension(R$dimen.tw_dp_h78));
        this.popItemTextSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_popItemTextSize, (int) getResources().getDimension(R$dimen.tw_dp_h24));
        this.popItemTextColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SingleChoosePreference_popItemTextColor, this.titleTextColor);
        this.mEntries = typedArrayObtainStyledAttributes.getTextArray(R$styleable.SingleChoosePreference_android_entries);
        this.f1231me = typedArrayObtainStyledAttributes.getTextArray(R$styleable.SingleChoosePreference_android_entryValues);
        this.popupBackground = typedArrayObtainStyledAttributes.getDrawable(R$styleable.SingleChoosePreference_popBackground);
        if (this.popupBackground == null) {
            this.popupBackground = this.context.getDrawable(R$drawable.preference_single_choose_item_bg);
        }
        this.f1235qe = typedArrayObtainStyledAttributes.getDrawable(R$styleable.SingleChoosePreference_popItemNormal);
        this.f1236re = typedArrayObtainStyledAttributes.getDrawable(R$styleable.SingleChoosePreference_popItemSelect);
        this.paddingLeft = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_paddingLeft, getResources().getDimension(R$dimen.tw_dp_w64));
        this.paddingRight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_paddingRight, getResources().getDimension(R$dimen.tw_dp_w64));
        this.rightIconWidth = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_rightIconWidth, getResources().getDimension(R$dimen.tw_dp_h75));
        this.rightIconHeight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SingleChoosePreference_rightIconHeight, getResources().getDimension(R$dimen.tw_dp_h75));
