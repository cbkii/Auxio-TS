...
public class ImagViewAndTextView extends FrameLayout {
    ...
    private void m1511a(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.inputView);
        this.f1172Xd = typedArrayObtainStyledAttributes.getResourceId(0, R.drawable.ic_launcher);
        this.f1173Yd = typedArrayObtainStyledAttributes.getString(1);
