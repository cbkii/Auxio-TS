...
/* JADX INFO: renamed from: com.eckom.xtlibrary.b.h.b.e */
...
public class C0665e<P extends AbstractC0658a> extends C0570a {
    ...
    public void m835_b() throws Throwable {
    ...
    public void m841bc() throws Throwable {
    ...
    public void next() {
        ...
        int length = c0659a.f762ll + 1;
        C0660a[] c0660aArr = c0659a.f734Gi;
        if (length > c0660aArr.length) {
            length = c0660aArr.length;
        }
        int i = length;
        while (true) {
            C0659a c0659a2 = this.f779Fi;
            C0660a[] c0660aArr2 = c0659a2.f734Gi;
            if (i >= c0660aArr2.length) {
                break;
            }
            if (c0660aArr2[i].f770tl != 0) {
                m828n(i, c0659a2.f749Xk);
                break;
            }
            i++;
        }
        if (i == this.f779Fi.f734Gi.length) {
            int i2 = 0;
            while (true) {
                if (i2 >= length) {
                    break;
                ...
                C0659a c0659a3 = this.f779Fi;
                if (c0659a3.f734Gi[i2].f770tl != 0) {
                    m828n(i2, c0659a3.f749Xk);
                    break;
                }
                i2++;
            }
    ...
    /* JADX INFO: renamed from: c */
    protected void m842c(Message message) throws Throwable {
        int i = message.arg2;
        if (i == 33 || i == 76) {
            m844cc();
        }
    ...
    protected void m837a(Message message) {
        ...
        if (i == 0) {
            ...
            if (i2 != i3) {
                ...
                if ((i4 & 2) == 2) {
                    Iterator<Map.Entry<String, InterfaceC0666f>> it = this.f788yh.entrySet().iterator();
                    while (it.hasNext()) {
                        it.next().getValue().mo873r((this.f784if & 2) == 2);
                    }
                }
                if ((i4 & 4) == 4) {
                    ...
                    Iterator<Map.Entry<String, InterfaceC0666f>> it2 = this.f788yh.entrySet().iterator();
                    while (it2.hasNext()) {
                        it2.next().getValue().mo879y((this.f784if & 4) == 4 ? 1 : 0);
                    }
                }
                if ((i4 & 8) == 8) {
                    ...
                    Iterator<Map.Entry<String, InterfaceC0666f>> it3 = this.f788yh.entrySet().iterator();
                    while (it3.hasNext()) {
                        it3.next().getValue().mo857S((this.f784if & 8) == 8 ? 1 : 0);
                    }
                }
                if ((i4 & 16) == 16) {
                    ...
                    Iterator<Map.Entry<String, InterfaceC0666f>> it4 = this.f788yh.entrySet().iterator();
                    while (it4.hasNext()) {
                        it4.next().getValue().mo868m((this.f784if & 16) == 16);
                    }
                }
        ...
        if (i != 1) {
            ...
            if (i == 3) {
                ...
                while (it6.hasNext()) {
                    it6.next().getValue().mo853A(message.arg2);
                }
                return;
            }
            if (i != 4) {
            ...
            while (it7.hasNext()) {
                it7.next().getValue().mo855I(this.f779Fi.f762ll);
            }
            return;
        }
        C0659a c0659a4 = this.f779Fi;
