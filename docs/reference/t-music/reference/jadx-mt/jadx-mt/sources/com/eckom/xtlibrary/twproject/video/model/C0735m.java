...
/* JADX INFO: renamed from: com.eckom.xtlibrary.twproject.video.model.m */
...
public class C0735m<P extends AbstractC0658a> extends BaseVideoMode {
    ...
    /* JADX INFO: renamed from: com.eckom.xtlibrary.twproject.video.model.m$a */
    /* JADX INFO: compiled from: VideoIjkModel.java */
    ...
    public void m1163Sa() throws Throwable {
        C0760l.m1298Sa();
    }
    ...
    public void m1208F(boolean z) {
        try {
            ...
            Log.w("VideoIjkModel", "showMultiScreen:" + e2.getMessage());
        }
        InterfaceC0708b interfaceC0708b = f912dj;
        if (interfaceC0708b != null) {
