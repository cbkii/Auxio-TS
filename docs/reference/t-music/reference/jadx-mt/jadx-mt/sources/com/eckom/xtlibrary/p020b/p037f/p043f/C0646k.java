...
/* JADX INFO: renamed from: com.eckom.xtlibrary.b.f.f.k */
/* JADX INFO: compiled from: PinyinConv.java */
...
public class C0646k {
    ...
    private static char m769b(char c2) {
        ...
        if ((c2 >= 'A' && c2 <= 'Z') || (iM770c = m770c(c2)) < 45217 || iM770c > 63486) {
            return c2;
        }
        int i = 0;
        while (i < 26) {
            int[] iArr = table;
            if (iM770c >= iArr[i] && iM770c < iArr[i + 1]) {
                break;
            }
            i++;
        }
