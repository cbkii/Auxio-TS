...
public class MusicWidgetProvider extends AppWidgetProvider {
    ...
    public void m1531a(MusicService musicService, int[] iArr) {
        ...
        String strM1369Nb = musicService.f1072Pa.m1369Nb();
        String strM1375jd = musicService.f1072Pa.m1375jd();
        if (strM1369Nb == null && (strM1369Nb = musicService.f1072Pa.m1369Nb()) == null) {
            musicService.getString(R.string.unknown);
        }
        remoteViews.setTextViewText(R.id.title, strM1369Nb);
        if (strM1375jd == null) {
            musicService.getString(R.string.unknown);
        }
        remoteViews.setTextViewText(R.id.artist, strM1375jd);
        ...
        Bitmap bitmapM1371ed = musicService.f1072Pa.m1371ed();
        if (bitmapM1371ed != null && bitmapM1371ed.getByteCount() <= 3680000) {
            remoteViews.setImageViewBitmap(R.id.albumart, bitmapM1371ed);
        } else {
