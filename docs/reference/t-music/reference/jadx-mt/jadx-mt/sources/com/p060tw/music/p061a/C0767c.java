...
/* JADX INFO: renamed from: com.tw.music.a.c */
...
public class C0767c extends BaseAdapter {
    ...
    /* JADX INFO: renamed from: com.tw.music.a.c$a */
    /* JADX INFO: compiled from: MusicAdapter.java */
    public interface a {
    ...
    /* JADX INFO: renamed from: com.tw.music.a.c$b */
    /* JADX INFO: compiled from: MusicAdapter.java */
    public interface b {
    ...
    /* JADX INFO: renamed from: com.tw.music.a.c$c */
    /* JADX INFO: compiled from: MusicAdapter.java */
    class c {
        ImageView file_ic;
        View itemView;
    ...
    private void m1359a(View view, int i, ViewGroup viewGroup) {
        ...
        try {
            Drawable drawableM964d = C0678h.m964d(C0681k.get().m973Kc(), "selector_item_bg");
            if (drawableM964d != null) {
                cVar.f1092vm.setBackground(drawableM964d);
                cVar.f1093wm.setBackground(drawableM964d);
            }
            Drawable drawableM964d2 = C0678h.m964d(C0681k.get().m973Kc(), "ic_wenjianjia");
            if (drawableM964d2 != null) {
                cVar.file_ic.setImageDrawable(drawableM964d2);
            }
            Drawable drawableM964d3 = C0678h.m964d(C0681k.get().m973Kc(), "selector_btn_icon");
            if (drawableM964d3 != null) {
                cVar.f1096zm.setImageDrawable(drawableM964d3);
            }
            Drawable drawableM964d4 = C0678h.m964d(C0681k.get().m973Kc(), "lev_play_now");
            if (drawableM964d4 != null) {
                cVar.iv_isPlaying.setImageDrawable(drawableM964d4);
                AnimationDrawable animationDrawable = (AnimationDrawable) cVar.iv_isPlaying.getDrawable();
                if (animationDrawable != null) {
                    animationDrawable.start();
                }
            }
            Drawable drawableM964d5 = C0678h.m964d(C0681k.get().m973Kc(), "selector_btn_collect_list");
            if (drawableM964d5 != null) {
                cVar.f1095ym.setImageDrawable(drawableM964d5);
            }
