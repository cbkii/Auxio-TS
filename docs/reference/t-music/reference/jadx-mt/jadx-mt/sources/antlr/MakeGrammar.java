...
public class MakeGrammar extends DefineGrammarSymbols {
    ...
    public static RuleBlock createNextTokenRule(Grammar grammar, Vector vector, String str) {
        ...
        for (int i = 0; i < vector.size(); i++) {
            ...
            if (!ruleSymbol.isDefined()) {
                ...
                StringBuilder sbM5a = C0000a.m5a("Lexer rule ");
                sbM5a.append(ruleSymbol.f304id.substring(1));
                sbM5a.append(" is not defined");
    ...
    private AlternativeBlock createOptionalRuleRef(String str, Token token) {
        ...
        String strEncodeLexerRuleName = CodeGenerator.encodeLexerRuleName(str);
        if (!this.grammar.isDefined(strEncodeLexerRuleName)) {
            this.grammar.define(new RuleSymbol(strEncodeLexerRuleName));
        }
        ...
        if (token != null) {
            for (int i = 0; i < this.ruleBlock.labeledElements.size(); i++) {
                ...
                if (label != null && label.equals(token.getText())) {
                    ...
                    sbM5a.append("' has already been defined");
    ...
    public void defineRuleName(Token token, String str, boolean z, String str2) {
        ...
        if (token.type == 24) {
            if (!(this.grammar instanceof LexerGrammar)) {
                Tool tool = this.tool;
                StringBuilder sbM5a = C0000a.m5a("Lexical rule ");
                sbM5a.append(token.getText());
                sbM5a.append(" defined outside of lexer");
                tool.error(sbM5a.toString(), this.grammar.getFilename(), token.getLine(), token.getColumn());
            ...
            StringBuilder sbM5a2 = C0000a.m5a("Lexical rule names must be upper case, '");
            sbM5a2.append(token.getText());
            sbM5a2.append("' is not");
            tool2.error(sbM5a2.toString(), this.grammar.getFilename(), token.getLine(), token.getColumn());
    ...
    public void refElementOption(Token token, Token token2) {
        AlternativeElement alternativeElementCurrentElement = context().currentElement();
        if ((alternativeElementCurrentElement instanceof StringLiteralElement) || (alternativeElementCurrentElement instanceof TokenRefElement) || (alternativeElementCurrentElement instanceof WildcardElement)) {
            ((GrammarAtom) alternativeElementCurrentElement).setOption(token, token2);
            return;
        }
        Tool tool = this.tool;
        StringBuilder sbM5a = C0000a.m5a("cannot use element option (");
        sbM5a.append(token.getText());
        sbM5a.append(") for this kind of element");
        tool.error(sbM5a.toString(), this.grammar.getFilename(), token.getLine(), token.getColumn());
    }
    ...
    public void refRule(Token token, Token token2, Token token3, Token token4, int i) {
        ...
        if (grammar instanceof LexerGrammar) {
            if (token2.type != 24) {
                Tool tool = this.tool;
                StringBuilder sbM5a = C0000a.m5a("Parser rule ");
                sbM5a.append(token2.getText());
                sbM5a.append(" referenced in lexer");
                tool.error(sbM5a.toString());
                return;
            }
            if (i == 2) {
        ...
        if ((grammar2 instanceof LexerGrammar) && !((LexerGrammar) grammar2).caseSensitive) {
            ...
            while (true) {
                if (i2 < token.getText().length() - 1) {
                    char cCharAt = token.getText().charAt(i2);
                    if (cCharAt < 128 && Character.toLowerCase(cCharAt) != cCharAt) {
    ...
    public void refTokensSpecElementOption(Token token, Token token2, Token token3) {
        ...
        if (tokenSymbol == null) {
            Tool tool = this.tool;
            StringBuilder sbM5a = C0000a.m5a("cannot find ");
            sbM5a.append(token.getText());
            sbM5a.append("in tokens {...}");
            tool.panic(sbM5a.toString());
        }
