...
public class TokenStreamRewriteEngine implements TokenStream, IASDebugStream {
    ...
    public static class RewriteOperation {
        ...
        public String toString() {
            ...
            StringBuilder sbM9b = C0000a.m9b(name.substring(name.indexOf(36) + 1, name.length()), "@");
            sbM9b.append(this.index);
            sbM9b.append('\"');
            sbM9b.append(this.text);
            sbM9b.append('\"');
    ...
    public void addToSortedRewriteList(String str, RewriteOperation rewriteOperation) {
        ...
        int iBinarySearch = Collections.binarySearch(program, rewriteOperation, new Comparator() { // from class: antlr.TokenStreamRewriteEngine.1
        ...
        boolean z = true;
        if (iBinarySearch >= 0) {
            while (iBinarySearch >= 0 && ((RewriteOperation) program.get(iBinarySearch)).index >= rewriteOperation.index) {
                iBinarySearch--;
            }
            i = iBinarySearch + 1;
