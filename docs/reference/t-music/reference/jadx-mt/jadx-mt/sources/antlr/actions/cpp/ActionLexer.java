...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
    ...
    /* JADX WARN: Removed duplicated region for block: B:49:0x0126 A[FALL_THROUGH] */
    ...
    */
    public final void mAST_CONSTRUCTOR(boolean z) throws NoViableAltForCharException, MismatchedCharException {
        ...
        char cMo105LA2 = mo105LA(1);
        if (cMo105LA2 != '\t' && cMo105LA2 != '\n' && cMo105LA2 != '\r' && cMo105LA2 != ' ') {
            if (cMo105LA2 != '(' && cMo105LA2 != '_' && cMo105LA2 != '\"' && cMo105LA2 != '#') {
                switch (cMo105LA2) {
                    case '0':
                    case '1':
                    case '2':
        ...
        String strProcessStringForASTConstructor = this.generator.processStringForASTConstructor(token2.getText());
        if (token != null) {
            strProcessStringForASTConstructor = C0000a.m0a(token, C0000a.m9b(strProcessStringForASTConstructor, ","));
        }
        this.text.setLength(length);
        this.text.append(this.generator.getASTCreateString(null, strProcessStringForASTConstructor));
        if (z) {
    ...
    */
    public final void mAST_ITEM(boolean z) throws NoViableAltForCharException, MismatchedCharException {
        ...
        if (mo105LA(1) == '#' && mo105LA(2) == '(') {
                ...
                if (cMo105LA != ':' && cMo105LA != '_') {
                    switch (cMo105LA) {
                        ...
                        case 'Z':
                            ...
                            text = token.getText();
                            strMapTreeId = this.generator.mapTreeId(token.getText(), this.transInfo);
                            if (strMapTreeId == null && !text.equals(strMapTreeId)) {
                                this.text.setLength(length);
            ...
            Token token2 = this._returnToken;
            text = token2.getText();
            strMapTreeId = this.generator.mapTreeId(token2.getText(), this.transInfo);
    ...
    /* JADX WARN: Removed duplicated region for block: B:70:0x011b A[PHI: r1
      0x011b: PHI (r1v2 char) = (r1v0 char), (r1v3 char), (r1v4 char), (r1v5 char), (r1v6 char), (r1v7 char), (r1v8 char) binds: [B:6:0x0018, B:8:0x001c, B:10:0x0020, B:12:0x0024, B:14:0x0028, B:16:0x002c, B:18:0x0030] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:71:0x011f A[PHI: r4
      0x011f: PHI (r4v1 char) = (r4v0 char), (r4v2 char) binds: [B:3:0x0012, B:5:0x0016] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:16:0x004f -> B:22:0x0075). Please report as a decompilation issue!!! */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:19:0x0068 -> B:21:0x0071). Please report as a decompilation issue!!! */
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:216:? A[FALL_THROUGH, SYNTHETIC] */
    ...
    */
    public final void mINT_OR_FLOAT(boolean z) throws NoViableAltForCharException {
        ...
        char c2 = 'L';
        if (mo105LA(1) != 'L' || !_tokenSet_26.member(mo105LA(2))) {
            c2 = 'l';
            if (mo105LA(1) == 'l' && _tokenSet_26.member(mo105LA(2))) {
                match(c2);
            } else if (mo105LA(1) == '.') {
                match('.');
                while (mo105LA(1) >= '0' && mo105LA(1) <= '9' && _tokenSet_26.member(mo105LA(2))) {
                    mDIGIT(false);
                }
            } else if (!_tokenSet_26.member(mo105LA(1))) {
                throw new NoViableAltForCharException(mo105LA(1), getFilename(), getLine(), getColumn());
            }
        }
        if (z) {
    ...
    */
    ...
    public final void mTEXT_ITEM(boolean z) throws NoViableAltForCharException {
        Token token;
        StringBuilder sb;
        String str;
        String strM0a;
        ...
        if (mo105LA(1) == '$' && mo105LA(2) == 'F' && mo105LA(3) == 'O') {
            ...
            strM0a = this.generator.getFOLLOWBitSet(ruleName, 1);
            if (strM0a == null) {
            ...
            if (mo105LA(1) == '$' && mo105LA(2) == 'F' && mo105LA(3) == 'I') {
                ...
                strM0a = this.generator.getFIRSTBitSet(ruleName, 1);
                if (strM0a == null) {
                    sb2 = new StringBuilder();
                    str2 = "$FIRST(";
                    sb2.append(str2);
                ...
                if (mo105LA(1) == '$' && mo105LA(2) == 'a') {
                    ...
                    if (mo105LA(1) == 'T' && mo105LA(2) == 'e') {
                        ...
                        match(')');
                        strM0a = "{ text.erase(_begin); text += " + token4.getText() + "; }";
    ...
    */
    public final void mTREE(boolean z) throws NoViableAltForCharException, MismatchedCharException {
        ...
        char cMo105LA = mo105LA(1);
        if (cMo105LA != '\t' && cMo105LA != '\n' && cMo105LA != '\r' && cMo105LA != ' ') {
            if (cMo105LA != '(' && cMo105LA != ':' && cMo105LA != '_' && cMo105LA != '\"' && cMo105LA != '#') {
                switch (cMo105LA) {
                    case 'A':
                    case 'B':
                    case 'C':
        ...
        while (mo105LA(1) == ',') {
            ...
            char cMo105LA3 = mo105LA(1);
            if (cMo105LA3 != '\t' && cMo105LA3 != '\n' && cMo105LA3 != '\r' && cMo105LA3 != ' ') {
                if (cMo105LA3 != c2 && cMo105LA3 != ':' && cMo105LA3 != '_' && cMo105LA3 != '\"') {
                    if (cMo105LA3 != '#') {
                        switch (cMo105LA3) {
                            case 'A':
                            case 'B':
                        ...
                        default:
                            if (mo105LA(1) == '#' && mo105LA(2) == '(') {
                                ...
                                if (mo105LA(1) == '#' && _tokenSet_12.member(mo105LA(2))) {
                                    ...
                                    Token token = this._returnToken;
                                    if (!zMID_ELEMENT && (strMapTreeId = this.generator.mapTreeId(token.getText(), null)) != null) {
                                    }
                                } else {
                                    if (mo105LA(1) != '#' || mo105LA(2) != '#') {
                                        throw new NoViableAltForCharException(mo105LA(1), getFilename(), getLine(), getColumn());
