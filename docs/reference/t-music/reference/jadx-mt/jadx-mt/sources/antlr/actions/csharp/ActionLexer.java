...
public class ActionLexer extends CharScanner implements ActionLexerTokenTypes, TokenStream {
    ...
    */
    public final void mAST_CONSTRUCTOR(boolean z) throws NoViableAltForCharException, MismatchedCharException {
        ...
        String strProcessStringForASTConstructor = this.generator.processStringForASTConstructor(token3.getText());
        if (token != null) {
            strProcessStringForASTConstructor = C0000a.m0a(token, C0000a.m9b(strProcessStringForASTConstructor, ","));
        }
        if (token2 != null) {
            strProcessStringForASTConstructor = C0000a.m0a(token2, C0000a.m9b(strProcessStringForASTConstructor, ","));
        }
    ...
    */
    public final void mID(boolean r8) throws antlr.NoViableAltForCharException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: antlr.actions.csharp.ActionLexer.mID(boolean):void");
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:193:? A[FALL_THROUGH, SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:193:? A[SYNTHETIC] */
    /* JADX WARN: Removed duplicated region for block: B:57:0x0139  */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public final boolean mID_ELEMENT(boolean z) throws NoViableAltForCharException {
        Token tokenMakeToken;
        ...
        if (cMo105LA != '(') {
            if (cMo105LA == '.') {
                ...
                while (mo105LA(1) == '[') {
                    ...
                    char cMo105LA2 = mo105LA(1);
                    if (cMo105LA2 != '\t' && cMo105LA2 != '\n' && cMo105LA2 != '\r' && cMo105LA2 != ' ') {
                        if (cMo105LA2 != '_' && cMo105LA2 != '\"' && cMo105LA2 != '#' && cMo105LA2 != '\'' && cMo105LA2 != '(') {
                            switch (cMo105LA2) {
                                case '0':
                                case '1':
                                case '2':
            ...
            char cMo105LA5 = mo105LA(1);
            if (cMo105LA5 != '\t' && cMo105LA5 != '\n' && cMo105LA5 != '\r' && cMo105LA5 != ' ') {
                if (cMo105LA5 != '_' && cMo105LA5 != '\"' && cMo105LA5 != '#') {
                    switch (cMo105LA5) {
                        case '\'':
                        case '(':
                            break;
    ...
    */
    ...
    public final void mTEXT_ARG_ID_ELEMENT(boolean z) throws NoViableAltForCharException {
        ...
        char cMo105LA = mo105LA(1);
        if (cMo105LA != '\t' && cMo105LA != '\n' && cMo105LA != '\r' && cMo105LA != ' ' && cMo105LA != '\"' && cMo105LA != '$' && cMo105LA != ']' && cMo105LA != '_') {
            switch (cMo105LA) {
                case '\'':
                case ')':
                    break;
