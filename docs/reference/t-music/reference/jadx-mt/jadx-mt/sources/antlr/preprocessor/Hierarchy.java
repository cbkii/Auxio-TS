...
public class Hierarchy {
    ...
    public static String optionsToString(IndexedVector indexedVector) {
        StringBuilder sbM5a = C0000a.m5a("options {");
        sbM5a.append(System.getProperty("line.separator"));
        String string = sbM5a.toString();
        Enumeration enumerationElements = indexedVector.elements();
        while (enumerationElements.hasMoreElements()) {
            StringBuilder sbM5a2 = C0000a.m5a(string);
            sbM5a2.append((Option) enumerationElements.nextElement());
    ...
    public void expandGrammarsInFile(String str) {
        Enumeration enumerationElements = getFile(str).getGrammars().elements();
        while (enumerationElements.hasMoreElements()) {
            ((Grammar) enumerationElements.nextElement()).expandInPlace();
        }
    }
    ...
    public boolean verifyThatHierarchyIsComplete() {
        Enumeration enumerationElements = this.symbols.elements();
        boolean z = true;
        while (enumerationElements.hasMoreElements()) {
            ...
            if (grammar.getSuperGrammarName() != null && grammar.getSuperGrammar() == null) {
                ...
                sbM5a.append(grammar.getSuperGrammarName());
                sbM5a.append(" not defined");
                tool.toolError(sbM5a.toString());
        ...
        Enumeration enumerationElements2 = this.symbols.elements();
        while (enumerationElements2.hasMoreElements()) {
            Grammar grammar2 = (Grammar) enumerationElements2.nextElement();
