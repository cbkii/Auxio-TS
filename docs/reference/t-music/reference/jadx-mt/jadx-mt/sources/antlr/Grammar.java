...
public abstract class Grammar {
    ...
    public boolean setOption(String str, Token token) {
        ...
        if (str.equals("k")) {
            try {
                ...
                StringBuilder sbM5a = C0000a.m5a("option 'k' must be an integer (was ");
                sbM5a.append(token.getText());
                sbM5a.append(")");
                tool.error(sbM5a.toString(), getFilename(), token.getLine(), token.getColumn());
            }
            return true;
        }
    ...
    public String toString() {
        ...
        Enumeration enumerationElements = this.rules.elements();
