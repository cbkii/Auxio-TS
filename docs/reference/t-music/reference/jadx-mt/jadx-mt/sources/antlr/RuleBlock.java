    ...
    public void addExceptionSpec(ExceptionSpec exceptionSpec) {
        if (findExceptionSpec(exceptionSpec.label) == null) {
            ...
            if (exceptionSpec.label == null) {
                ...
                sbM5a.append(this.ruleName);
                sbM5a.append("' already has an exception handler");
                tool.error(sbM5a.toString());
                return;
            }
            Tool tool2 = this.grammar.antlrTool;
            StringBuilder sbM5a2 = C0000a.m5a("Rule '");
            sbM5a2.append(this.ruleName);
            sbM5a2.append("' already has an exception handler for label: ");
            sbM5a2.append(exceptionSpec.label);
                ...
                if (token.getText().equals("ignore")) {
                    ...
                    if (grammar3 instanceof LexerGrammar) {
                        ...
                        if (tokenSymbol == null) {
                            ...
                            StringBuilder sbM5a = C0000a.m5a("cannot find token associated with rule ");
                            sbM5a.append(this.ruleName);
                            tool3.panic(sbM5a.toString());
                        }
    ...
    public String toString() {
        ...
        for (int i2 = 1; i2 <= i; i2++) {
            if (lookaheadArr[i2] != null) {
                ...
                sbM5a.append(lookaheadArr[i2].toString(",", this.grammar.tokenManager.getVocabulary()));
        ...
        String strM1a = C0000a.m1a(str, "}");
        if (z) {
            strM1a = "";
        }
        return this.ruleName + ": " + super.toString() + " ;" + strM1a;
    }
}
