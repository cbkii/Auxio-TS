...
class FindAddress {
    ...
    private static final String f249NL = "\n\u000b\f\r\u0085\u2028\u2029";

    /* JADX INFO: renamed from: SP */
    private static final String f250SP = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000";
    private static final String WORD_DELIM = ",*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
    private static final String WORD_END = "(?=[,*•\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029]|$)";

    /* JADX INFO: renamed from: WS */
    private static final String f251WS = "\t  \u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006 \u2008\u2009\u200a \u205f\u3000\n\u000b\f\r\u0085\u2028\u2029";
            ...
            if (iEnd < str.length()) {
                ...
                if (matcher.end() - matcher.start() <= 25) {
                    while (iEnd < matcher.start()) {
                        int i4 = iEnd + 1;
                        if (f249NL.indexOf(str.charAt(iEnd)) != -1) {
                            i3++;
                        }
                        iEnd = i4;
                    }
                    ...
                    if (matchHouseNumber(str, iEnd) == null) {
                        if (!isValidLocationName(matcher.group(0))) {
                            ...
                            if (z && i2 > 4 && (matchResultMatchState = matchState(str, iEnd)) != null) {
