...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        @FloatRange(from = 0.0d, m72to = 1.0d)
    ...
    protected void onMeasure(int i, int i2) {
        ...
        while (i13 < size3) {
            ...
            if (view.getVisibility() == 8) {
                ...
                int i14 = layoutParams2.keyline;
                if (i14 < 0 || mode == 0) {
                    i3 = i12;
                } else {
                    int keyline = getKeyline(i14);
                    ...
                    if (behavior == null) {
                        ...
                        int iMax2 = Math.max(i5, i9 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin);
                        int iMax3 = Math.max(i7, i10 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams3).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).bottomMargin);
                        i11 = iMax2;
                    ...
                    int iMax22 = Math.max(i5, i9 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams32).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams32).rightMargin);
                    int iMax32 = Math.max(i7, i10 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams32).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams32).bottomMargin);
                    i11 = iMax22;
                    iCombineMeasuredStates = View.combineMeasuredStates(i4, view.getMeasuredState());
                    i12 = iMax32;
                }
                ...
                if (z2) {
                    ...
                    int iMax222 = Math.max(i5, i9 + view.getMeasuredWidth() + ((ViewGroup.MarginLayoutParams) layoutParams322).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams322).rightMargin);
                    int iMax322 = Math.max(i7, i10 + view.getMeasuredHeight() + ((ViewGroup.MarginLayoutParams) layoutParams322).topMargin + ((ViewGroup.MarginLayoutParams) layoutParams322).bottomMargin);
                    i11 = iMax222;
                    iCombineMeasuredStates = View.combineMeasuredStates(i4, view.getMeasuredState());
                    i12 = iMax322;
                }
        ...
        setMeasuredDimension(View.resolveSizeAndState(i11, i, (-16777216) & i15), View.resolveSizeAndState(i12, i2, i15 << 16));
    }
    ...
    */
    ...
    public CoordinatorLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i) {
        ...
        if (i == 0) {
            typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0033R.styleable.CoordinatorLayout, 0, C0033R.style.Widget_Support_CoordinatorLayout);
        } else {
            typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0033R.styleable.CoordinatorLayout, i, 0);
        }
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(C0033R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArrayObtainStyledAttributes.getDrawable(C0033R.styleable.CoordinatorLayout_statusBarBackground);
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        LayoutParams(@NonNull Context context, @Nullable AttributeSet attributeSet) {
            ...
            this.dodgeInsetEdges = 0;
            this.mLastChildRect = new Rect();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0033R.styleable.CoordinatorLayout_Layout);
            this.gravity = typedArrayObtainStyledAttributes.getInteger(C0033R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = typedArrayObtainStyledAttributes.getResourceId(C0033R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = typedArrayObtainStyledAttributes.getInteger(C0033R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = typedArrayObtainStyledAttributes.getInteger(C0033R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = typedArrayObtainStyledAttributes.getInt(C0033R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = typedArrayObtainStyledAttributes.getInt(C0033R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = typedArrayObtainStyledAttributes.hasValue(C0033R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, typedArrayObtainStyledAttributes.getString(C0033R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
            typedArrayObtainStyledAttributes.recycle();
            Behavior behavior = this.mBehavior;
            if (behavior != null) {
