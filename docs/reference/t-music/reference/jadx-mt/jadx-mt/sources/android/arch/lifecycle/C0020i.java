...
/* JADX INFO: renamed from: android.arch.lifecycle.i */
...
public class C0020i {
    ...
    private static Constructor<? extends InterfaceC0014c> m64e(Class<?> cls) {
        try {
            ...
            String strM68la = m68la(canonicalName);
            if (!name.isEmpty()) {
                strM68la = name + "." + strM68la;
            }
            Constructor declaredConstructor = Class.forName(strM68la).getDeclaredConstructor(cls);
    ...
    private static int m65f(Class<?> cls) {
        ...
        int iM67h = m67h(cls);
        f58Ka.put(cls, Integer.valueOf(iM67h));
        return iM67h;
    }
    ...
    private static int m67h(Class<?> cls) {
        ...
        Constructor<? extends InterfaceC0014c> constructorM64e = m64e(cls);
        if (constructorM64e != null) {
            f59La.put(cls, Collections.singletonList(constructorM64e));
            return 2;
        }
