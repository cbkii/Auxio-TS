...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private final Runnable mInvalidatePanelMenuRunnable = new Runnable() { // from class: android.support.v7.app.AppCompatDelegateImpl.2
        ...
        public void run() {
            ...
            appCompatDelegateImpl3.mInvalidatePanelMenuPosted = AppCompatDelegateImpl.DEBUG;
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            TintTypedArray tintTypedArrayObtainStyledAttributes = TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), (AttributeSet) null, new int[]{C0443R.attr.homeAsUpIndicator});
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static SavedState readFromParcel(Parcel parcel, ClassLoader classLoader) {
                ...
                savedState.isOpen = parcel.readInt() != 1 ? AppCompatDelegateImpl.DEBUG : true;
        ...
        MenuView getListMenuView(MenuPresenter.Callback callback) {
            ...
            if (this.listMenuPresenter == null) {
                this.listMenuPresenter = new ListMenuPresenter(this.listPresenterContext, C0443R.layout.abc_list_menu_item_layout);
        ...
        void setStyle(Context context) {
            ...
            themeNewTheme.resolveAttribute(C0443R.attr.actionBarPopupTheme, typedValue, true);
            int i = typedValue.resourceId;
            if (i != 0) {
                themeNewTheme.applyStyle(i, true);
            }
            themeNewTheme.resolveAttribute(C0443R.attr.panelMenuListTheme, typedValue, true);
            int i2 = typedValue.resourceId;
            if (i2 != 0) {
                themeNewTheme.applyStyle(i2, true);
            } else {
                themeNewTheme.applyStyle(C0443R.style.Theme_AppCompat_CompactMenu, true);
            }
            ContextThemeWrapper contextThemeWrapper = new ContextThemeWrapper(context, 0);
            contextThemeWrapper.getTheme().setTo(themeNewTheme);
            this.listPresenterContext = contextThemeWrapper;
            TypedArray typedArrayObtainStyledAttributes = contextThemeWrapper.obtainStyledAttributes(C0443R.styleable.AppCompatTheme);
            this.background = typedArrayObtainStyledAttributes.getResourceId(C0443R.styleable.AppCompatTheme_panelBackground, 0);
            this.windowAnimations = typedArrayObtainStyledAttributes.getResourceId(C0443R.styleable.AppCompatTheme_android_windowAnimationStyle, 0);
    ...
    private void applyFixedSizeWindow() {
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C0443R.styleable.AppCompatTheme);
        typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowMinWidthMajor, contentFrameLayout.getMinWidthMajor());
        typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowMinWidthMinor, contentFrameLayout.getMinWidthMinor());
        if (typedArrayObtainStyledAttributes.hasValue(C0443R.styleable.AppCompatTheme_windowFixedWidthMajor)) {
            typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowFixedWidthMajor, contentFrameLayout.getFixedWidthMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0443R.styleable.AppCompatTheme_windowFixedWidthMinor)) {
            typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowFixedWidthMinor, contentFrameLayout.getFixedWidthMinor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0443R.styleable.AppCompatTheme_windowFixedHeightMajor)) {
            typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowFixedHeightMajor, contentFrameLayout.getFixedHeightMajor());
        }
        if (typedArrayObtainStyledAttributes.hasValue(C0443R.styleable.AppCompatTheme_windowFixedHeightMinor)) {
            typedArrayObtainStyledAttributes.getValue(C0443R.styleable.AppCompatTheme_windowFixedHeightMinor, contentFrameLayout.getFixedHeightMinor());
        }
        typedArrayObtainStyledAttributes.recycle();
    ...
    private ViewGroup createSubDecor() {
        ViewGroup viewGroup;
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(C0443R.styleable.AppCompatTheme);
        if (!typedArrayObtainStyledAttributes.hasValue(C0443R.styleable.AppCompatTheme_windowActionBar)) {
            typedArrayObtainStyledAttributes.recycle();
            throw new IllegalStateException("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.AppCompatTheme_windowNoTitle, DEBUG)) {
            requestWindowFeature(1);
        } else if (typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.AppCompatTheme_windowActionBar, DEBUG)) {
            requestWindowFeature(108);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.AppCompatTheme_windowActionBarOverlay, DEBUG)) {
            requestWindowFeature(109);
        }
        if (typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.AppCompatTheme_windowActionModeOverlay, DEBUG)) {
            requestWindowFeature(10);
        }
        this.mIsFloating = typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.AppCompatTheme_android_windowIsFloating, DEBUG);
        typedArrayObtainStyledAttributes.recycle();
        this.mWindow.getDecorView();
        LayoutInflater layoutInflaterFrom = LayoutInflater.from(this.mContext);
        if (this.mWindowNoTitle) {
            viewGroup = this.mOverlayActionMode ? (ViewGroup) layoutInflaterFrom.inflate(C0443R.layout.abc_screen_simple_overlay_action_mode, (ViewGroup) null) : (ViewGroup) layoutInflaterFrom.inflate(C0443R.layout.abc_screen_simple, (ViewGroup) null);
            ...
            viewGroup = (ViewGroup) layoutInflaterFrom.inflate(C0443R.layout.abc_dialog_title_material, (ViewGroup) null);
            this.mOverlayActionBar = DEBUG;
            this.mHasActionBar = DEBUG;
        } else if (this.mHasActionBar) {
            TypedValue typedValue = new TypedValue();
            this.mContext.getTheme().resolveAttribute(C0443R.attr.actionBarTheme, typedValue, true);
            int i = typedValue.resourceId;
            viewGroup = (ViewGroup) LayoutInflater.from(i != 0 ? new ContextThemeWrapper(this.mContext, i) : this.mContext).inflate(C0443R.layout.abc_screen_toolbar, (ViewGroup) null);
            this.mDecorContentParent = (DecorContentParent) viewGroup.findViewById(C0443R.id.decor_content_parent);
        ...
        if (this.mDecorContentParent == null) {
            this.mTitleView = (TextView) viewGroup.findViewById(C0443R.id.title);
        }
        ViewUtils.makeOptionalFitsSystemWindows(viewGroup);
        ContentFrameLayout contentFrameLayout = (ContentFrameLayout) viewGroup.findViewById(C0443R.id.action_bar_activity_content);
    ...
    private boolean initializePanelMenu(PanelFeatureState panelFeatureState) {
        ...
        if ((i == 0 || i == 108) && this.mDecorContentParent != null) {
            ...
            theme.resolveAttribute(C0443R.attr.actionBarTheme, typedValue, true);
            Resources.Theme themeNewTheme = null;
            if (typedValue.resourceId != 0) {
                themeNewTheme = context.getResources().newTheme();
                themeNewTheme.setTo(theme);
                themeNewTheme.applyStyle(typedValue.resourceId, true);
                themeNewTheme.resolveAttribute(C0443R.attr.actionBarWidgetTheme, typedValue, true);
            } else {
                theme.resolveAttribute(C0443R.attr.actionBarWidgetTheme, typedValue, true);
            }
            if (typedValue.resourceId != 0) {
    ...
    */
    ...
    private void openPanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        if (windowManager != null && preparePanel(panelFeatureState, keyEvent)) {
            if (panelFeatureState.decorView != null && !panelFeatureState.refreshDecorView) {
                ...
                WindowManager.LayoutParams layoutParams2 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f255x, panelFeatureState.f256y, 1002, 8519680, -3);
            ...
            i = -2;
            panelFeatureState.isHandled = DEBUG;
            WindowManager.LayoutParams layoutParams22 = new WindowManager.LayoutParams(i, -2, panelFeatureState.f255x, panelFeatureState.f256y, 1002, 8519680, -3);
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (appCompatViewInflater == null) {
            String string = this.mContext.obtainStyledAttributes(C0443R.styleable.AppCompatTheme).getString(C0443R.styleable.AppCompatTheme_viewInflaterClass);
    ...
    boolean dispatchKeyEvent(KeyEvent keyEvent) {
        ...
        if (!(keyEvent.getAction() == 0 ? true : DEBUG) ? onKeyUp(keyCode, keyEvent) : onKeyDown(keyCode, keyEvent)) {
        ...
        if (actionModeOnWindowStartingSupportActionMode != null) {
            ...
            if (this.mActionModeView == null) {
                if (this.mIsFloating) {
                    ...
                    this.mActionModePopup = new PopupWindow(contextThemeWrapper, (AttributeSet) null, C0443R.attr.actionModePopupWindowStyle);
                    PopupWindowCompat.setWindowLayoutType(this.mActionModePopup, 2);
                    this.mActionModePopup.setContentView(this.mActionModeView);
                    this.mActionModePopup.setWidth(-1);
                    contextThemeWrapper.getTheme().resolveAttribute(C0443R.attr.actionBarSize, typedValue, true);
                    ...
                    ViewStubCompat viewStubCompat = (ViewStubCompat) this.mSubDecor.findViewById(C0443R.id.action_mode_bar_stub);
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin != (rect2.top == 0 ? i : 0)) {
                    ...
                    if (view == null) {
                        ...
                        this.mStatusGuard.setBackgroundColor(this.mContext.getResources().getColor(C0443R.color.abc_input_method_navigation_guard));
