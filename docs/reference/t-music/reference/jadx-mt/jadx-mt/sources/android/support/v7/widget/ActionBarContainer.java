...
public class ActionBarContainer extends FrameLayout {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0443R.id.action_bar);
        this.mContextView = findViewById(C0443R.id.action_context_bar);
    }
    ...
    */
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0443R.styleable.ActionBar);
        this.mBackground = typedArrayObtainStyledAttributes.getDrawable(C0443R.styleable.ActionBar_background);
        this.mStackedBackground = typedArrayObtainStyledAttributes.getDrawable(C0443R.styleable.ActionBar_backgroundStacked);
        this.mHeight = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0443R.styleable.ActionBar_height, -1);
        if (getId() == C0443R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = typedArrayObtainStyledAttributes.getDrawable(C0443R.styleable.ActionBar_backgroundSplit);
        }
