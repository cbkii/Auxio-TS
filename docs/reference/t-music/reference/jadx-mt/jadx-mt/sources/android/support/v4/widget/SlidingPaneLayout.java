...
public class SlidingPaneLayout extends ViewGroup {
    ...
    */
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.slideable) {
                    ...
                    int iMin = (Math.min(width, i13 - this.mOverhangSize) - i11) - (((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin);
    ...
    /* JADX WARN: Removed duplicated region for block: B:40:0x00ae A[PHI: r12
      0x00ae: PHI (r12v2 float) = (r12v1 float), (r12v3 float) binds: [B:36:0x00a5, B:38:0x00aa] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
                    ...
                    if (childAt2.getVisibility() != i3) {
                        ...
                        if (!z2 || childAt2 == this.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                ...
                                if (z2) {
                                    int i11 = paddingLeft - (((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin);
                                    i4 = i9;
                        ...
                        } else if (((ViewGroup.MarginLayoutParams) layoutParams2).width < 0 && (measuredWidth2 > i9 || layoutParams2.weight > 0.0f)) {
                            if (!z5) {
                                i5 = 1073741824;
    ...
    void onPanelDragged(int i) {
        ...
        this.mSlideOffset = (i - ((zIsLayoutRtlSupport ? getPaddingRight() : getPaddingLeft()) + (zIsLayoutRtlSupport ? ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin : ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin))) / this.mSlideRange;
        if (this.mParallaxBy != 0) {
            parallaxOtherViews(this.mSlideOffset);
        }
        if (layoutParams.dimWhenOffset) {
