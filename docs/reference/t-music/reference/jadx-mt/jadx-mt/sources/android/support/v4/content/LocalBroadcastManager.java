            ...
            if (arrayList3 != null) {
                ...
                while (i2 < arrayList3.size()) {
                    ...
                    if (receiverRecord.broadcasting) {
                        ...
                        if (iMatch >= 0) {
                            ...
                            Log.v(TAG, "  Filter did not match: " + (iMatch != -4 ? iMatch != -3 ? iMatch != -2 ? iMatch != -1 ? "unknown reason" : IjkMediaMeta.IJKM_KEY_TYPE : "data" : "action" : "category"));
                        }
                    }
                ...
                if (arrayList5 != null) {
                    for (int i3 = 0; i3 < arrayList5.size(); i3++) {
                        ((ReceiverRecord) arrayList5.get(i3)).broadcasting = DEBUG;
                    }
