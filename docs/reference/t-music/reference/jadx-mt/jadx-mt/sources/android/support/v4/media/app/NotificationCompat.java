...
public class NotificationCompat {
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        private void setBackgroundColor(RemoteViews remoteViews) {
            remoteViews.setInt(C0051R.id.status_bar_latest_event_content, "setBackgroundColor", this.mBuilder.getColor() != 0 ? this.mBuilder.getColor() : this.mBuilder.mContext.getResources().getColor(C0051R.color.notification_material_background_media_default_color));
        }
        ...
        int getContentViewLayoutResource() {
            return this.mBuilder.getContentView() != null ? C0051R.layout.notification_template_media_custom : super.getContentViewLayoutResource();
        }
    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        private RemoteViews generateMediaActionButton(NotificationCompat.Action action) {
            ...
            remoteViews.setImageViewResource(C0051R.id.action0, action.getIcon());
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0051R.id.action0, action.getActionIntent());
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0051R.id.action0, action.getTitle());
            }
            return remoteViews;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            remoteViewsApplyStandardTemplate.removeAllViews(C0051R.id.media_actions);
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0051R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.cancel_action, 0);
                remoteViewsApplyStandardTemplate.setInt(C0051R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0051R.integer.cancel_button_image_alpha));
                remoteViewsApplyStandardTemplate.setOnClickPendingIntent(C0051R.id.cancel_action, this.mCancelButtonIntent);
            } else {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.cancel_action, 8);
            }
        ...
        RemoteViews generateContentView() {
            ...
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    ...
                    remoteViewsApplyStandardTemplate.addView(C0051R.id.media_actions, generateMediaActionButton(this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.end_padder, 8);
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.cancel_action, 0);
                remoteViewsApplyStandardTemplate.setOnClickPendingIntent(C0051R.id.cancel_action, this.mCancelButtonIntent);
                remoteViewsApplyStandardTemplate.setInt(C0051R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0051R.integer.cancel_button_image_alpha));
            } else {
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.end_padder, 0);
                remoteViewsApplyStandardTemplate.setViewVisibility(C0051R.id.cancel_action, 8);
            }
            return remoteViewsApplyStandardTemplate;
        }
