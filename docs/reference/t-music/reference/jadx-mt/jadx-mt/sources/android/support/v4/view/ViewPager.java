    ...
    */
    ...
    void dataSetChanged() {
        ...
        if (z) {
            ...
            setCurrentItemInternal(iMax, DEBUG, true);
            requestLayout();
        }
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.mFirstLayout) {
            ...
            z2 = DEBUG;
            scrollToItem(i16, DEBUG, 0, DEBUG);
        } else {
            z2 = DEBUG;
        }
    ...
    */
    void populate(int i) {
        ...
        if (count != this.mExpectedAdapterCount) {
            ...
            throw new IllegalStateException("The application's PagerAdapter changed the adapter's contents without calling PagerAdapter#notifyDataSetChanged! Expected adapter item count: " + this.mExpectedAdapterCount + ", found: " + count + " Pager id: " + hexString + " Pager class: " + ViewPager.class + " Problematic adapter: " + this.mAdapter.getClass());
        }
        int i4 = 0;
        while (true) {
        ...
        if (itemInfoAddNewItem != null) {
            ...
            for (int i10 = this.mCurItem - 1; i10 >= 0; i10--) {
                if (f >= paddingLeft && i10 < iMax) {
                    ...
                    i9++;
                    itemInfo = i8 >= 0 ? this.mItems.get(i8) : null;
                    itemInfo2 = itemInfo;
                } else {
            ...
            int i11 = i9 + 1;
            if (f2 < 2.0f) {
                ItemInfo itemInfo3 = i11 < this.mItems.size() ? this.mItems.get(i11) : null;
                ...
                while (true) {
                    ...
                    if (f2 >= paddingRight && i12 > iMin) {
                        if (itemInfo3 == null) {
                            break;
                        }
                        if (i12 == itemInfo3.position && !itemInfo3.scrolling) {
                            this.mItems.remove(i11);
                            this.mAdapter.destroyItem((ViewGroup) this, i12, itemInfo3.object);
                            if (i11 < this.mItems.size()) {
                                itemInfo3 = this.mItems.get(i11);
                            }
                        }
                    } else if (itemInfo3 == null || i12 != itemInfo3.position) {
                        ItemInfo itemInfoAddNewItem2 = addNewItem(i12, i11);
                        i11++;
                        f2 += itemInfoAddNewItem2.widthFactor;
                        itemInfo3 = i11 < this.mItems.size() ? this.mItems.get(i11) : null;
                    } else {
            ...
            calculatePageOffsets(itemInfoAddNewItem, i9, itemInfoInfoForPosition);
