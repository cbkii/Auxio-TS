...
class C0012a {
    ...
    boolean m43b(Class cls) {
        ...
        Method[] methodArrM41d = m41d(cls);
        for (Method method : methodArrM41d) {
            if (((InterfaceC0025n) method.getAnnotation(InterfaceC0025n.class)) != null) {
                m39a(cls, methodArrM41d);
                return true;
            }
        }
    ...
    static class a {
        ...
        a(Map<b, Lifecycle.Event> map) {
            ...
            for (Map.Entry<b, Lifecycle.Event> entry : map.entrySet()) {
                ...
                List<b> arrayList = this.f47ya.get(value);
                if (arrayList == null) {
                    arrayList = new ArrayList<>();
                    this.f47ya.put(value, arrayList);
                }
    ...
    private a m39a(Class cls, @Nullable Method[] methodArr) {
        ...
        if (superclass != null && (aVarM42a = m42a(superclass)) != null) {
            map.putAll(aVarM42a.f48za);
        }
        for (Class<?> cls2 : cls.getInterfaces()) {
            for (Map.Entry<b, Lifecycle.Event> entry : m42a(cls2).f48za.entrySet()) {
                m40a(map, entry.getKey(), entry.getValue(), cls);
            }
        }
        if (methodArr == null) {
            methodArr = m41d(cls);
        ...
        for (Method method : methodArr) {
            ...
            if (interfaceC0025n != null) {
                ...
                Lifecycle.Event eventValue = interfaceC0025n.value();
                ...
                if (parameterTypes.length <= 2) {
                    m40a(map, new b(i, method), eventValue, cls);
                    z = true;
                } else {
