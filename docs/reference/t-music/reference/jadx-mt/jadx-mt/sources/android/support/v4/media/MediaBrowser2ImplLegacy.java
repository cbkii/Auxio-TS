...
class MediaBrowser2ImplLegacy extends MediaController2ImplLegacy implements MediaBrowser2.SupportLibraryImpl {
    ...
    public void getChildren(@NonNull String str, int i, int i2, @Nullable Bundle bundle) {
        ...
        Bundle bundleCreateBundle = MediaUtils2.createBundle(bundle);
        bundleCreateBundle.putInt(MediaBrowserCompat.EXTRA_PAGE, i);
        bundleCreateBundle.putInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, i2);
        browserCompat.subscribe(str, bundleCreateBundle, new GetChildrenCallback(str, i, i2));
    }
    ...
    public void getLibraryRoot(@Nullable final Bundle bundle) {
        ...
        if (browserCompat != null) {
            ...
            getCallbackExecutor().execute(new Runnable() { // from class: android.support.v4.media.MediaBrowser2ImplLegacy.2
                @Override // java.lang.Runnable
                public void run() {
                    MediaBrowserCompat mediaBrowserCompat = new MediaBrowserCompat(MediaBrowser2ImplLegacy.this.getContext(), MediaBrowser2ImplLegacy.this.getSessionToken().getComponentName(), MediaBrowser2ImplLegacy.this.new GetLibraryRootCallback(bundle), bundle);
                    synchronized (MediaBrowser2ImplLegacy.this.mLock) {
    ...
    public void getSearchResult(@NonNull String str, final int i, final int i2, @Nullable final Bundle bundle) {
        ...
        bundleCreateBundle.putInt(MediaBrowserCompat.EXTRA_PAGE, i);
        bundleCreateBundle.putInt(MediaBrowserCompat.EXTRA_PAGE_SIZE, i2);
        browserCompat.search(str, bundleCreateBundle, new MediaBrowserCompat.SearchCallback() { // from class: android.support.v4.media.MediaBrowser2ImplLegacy.5
            ...
            public void onError(final String str2, Bundle bundle2) {
                MediaBrowser2ImplLegacy.this.getCallbackExecutor().execute(new Runnable() { // from class: android.support.v4.media.MediaBrowser2ImplLegacy.5.2
                    ...
                    public void run() {
                        ...
                        String str3 = str2;
                        C01135 c01135 = C01135.this;
                        callback.onGetSearchResultDone(mediaBrowser2ImplLegacy, str3, i, i2, null, bundle);
                    }
                });
            }
            ...
            public void onSearchResult(final String str2, Bundle bundle2, final List<MediaBrowserCompat.MediaItem> list) {
                MediaBrowser2ImplLegacy.this.getCallbackExecutor().execute(new Runnable() { // from class: android.support.v4.media.MediaBrowser2ImplLegacy.5.1
                    @Override // java.lang.Runnable
                    public void run() {
                        List<MediaItem2> listConvertMediaItemListToMediaItem2List = MediaUtils2.convertMediaItemListToMediaItem2List(list);
                        MediaBrowser2.BrowserCallback callback = MediaBrowser2ImplLegacy.this.getCallback();
                        MediaBrowser2 mediaBrowser2ImplLegacy = MediaBrowser2ImplLegacy.this.getInstance();
                        String str3 = str2;
                        C01135 c01135 = C01135.this;
                        callback.onGetSearchResultDone(mediaBrowser2ImplLegacy, str3, i, i2, listConvertMediaItemListToMediaItem2List, bundle);
                    }
                });
            }
        });
