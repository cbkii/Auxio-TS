...
public class ClosedCaptionRenderer extends SubtitleController.Renderer {
    ...
    class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
        ...
        private class CCLineBox extends TextView {
            ...
            CCLineBox(Context context) {
                ...
                this.mShadowOffset = resources.getDimensionPixelSize(C0051R.dimen.subtitle_shadow_offset);
            }
    ...
    public SubtitleTrack createTrack(MediaFormat mediaFormat) {
        if (SubtitleData2.MIMETYPE_TEXT_CEA_608.equals(mediaFormat.getString(IMediaFormat.KEY_MIME))) {
    ...
    public boolean supports(MediaFormat mediaFormat) {
        if (mediaFormat.containsKey(IMediaFormat.KEY_MIME)) {
            return SubtitleData2.MIMETYPE_TEXT_CEA_608.equals(mediaFormat.getString(IMediaFormat.KEY_MIME));
        }
        return false;
    }
}
