...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m1589clone() {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            ...
            int iMin;
            boolean z2 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0031R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0031R.id.actions);
            if (!z || (arrayList = this.mBuilder.mActions) == null || (iMin = Math.min(arrayList.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0031R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0031R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0031R.id.action_divider, i2);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z ? C0031R.layout.notification_action_tombstone : C0031R.layout.notification_action);
            remoteViews.setImageViewBitmap(C0031R.id.action_image, createColoredBitmap(action.getIcon(), this.mBuilder.mContext.getResources().getColor(C0031R.color.notification_action_color_filter)));
            remoteViews.setTextViewText(C0031R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C0031R.id.action_container, action.actionIntent);
            }
            if (Build.VERSION.SDK_INT >= 15) {
                remoteViews.setContentDescription(C0031R.id.action_container, action.title);
            }
            return remoteViews;
        }
    ...
    public static abstract class Style {
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C0031R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C0031R.id.title, 8);
            remoteViews.setViewVisibility(C0031R.id.text2, 8);
            remoteViews.setViewVisibility(C0031R.id.text, 8);
        }
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (i2 >= 16 && i2 < 21) {
                if (z5) {
                    remoteViews.setInt(C0031R.id.notification_background, "setBackgroundResource", C0031R.drawable.notification_bg_low);
                    remoteViews.setInt(C0031R.id.icon, "setBackgroundResource", C0031R.drawable.notification_template_icon_low_bg);
                } else {
                    remoteViews.setInt(C0031R.id.notification_background, "setBackgroundResource", C0031R.drawable.notification_bg);
                    remoteViews.setInt(C0031R.id.icon, "setBackgroundResource", C0031R.drawable.notification_template_icon_bg);
                }
            }
            Builder builder = this.mBuilder;
            if (builder.mLargeIcon != null) {
                if (Build.VERSION.SDK_INT >= 16) {
                    remoteViews.setViewVisibility(C0031R.id.icon, 0);
                    remoteViews.setImageViewBitmap(C0031R.id.icon, this.mBuilder.mLargeIcon);
                } else {
                    remoteViews.setViewVisibility(C0031R.id.icon, 8);
                }
                if (z && this.mBuilder.mNotification.icon != 0) {
                    ...
                    if (Build.VERSION.SDK_INT >= 21) {
                        ...
                        remoteViews.setImageViewBitmap(C0031R.id.right_icon, createIconWithBackground(builder2.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, builder2.getColor()));
                    } else {
                        remoteViews.setImageViewBitmap(C0031R.id.right_icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                    }
                    remoteViews.setViewVisibility(C0031R.id.right_icon, 0);
                }
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    remoteViews.setImageViewBitmap(C0031R.id.icon, createIconWithBackground(builder3.mNotification.icon, dimensionPixelSize3, dimensionPixelSize4, builder3.getColor()));
                } else {
                    remoteViews.setImageViewBitmap(C0031R.id.icon, createColoredBitmap(this.mBuilder.mNotification.icon, -1));
                }
            }
            CharSequence charSequence2 = this.mBuilder.mContentTitle;
            if (charSequence2 != null) {
                remoteViews.setTextViewText(C0031R.id.title, charSequence2);
            }
            CharSequence charSequence3 = this.mBuilder.mContentText;
            if (charSequence3 != null) {
                remoteViews.setTextViewText(C0031R.id.text, charSequence3);
                z3 = true;
            } else {
                z3 = false;
            }
            ...
            if (charSequence4 != null) {
                remoteViews.setTextViewText(C0031R.id.info, charSequence4);
                remoteViews.setViewVisibility(C0031R.id.info, 0);
            } else {
                if (builder4.mNumber <= 0) {
                    remoteViews.setViewVisibility(C0031R.id.info, 8);
                    charSequence = this.mBuilder.mSubText;
                    if (charSequence != null || Build.VERSION.SDK_INT < 16) {
                        z4 = false;
                    } else {
                        remoteViews.setTextViewText(C0031R.id.text, charSequence);
                        CharSequence charSequence5 = this.mBuilder.mContentText;
                        if (charSequence5 != null) {
                            remoteViews.setTextViewText(C0031R.id.text2, charSequence5);
                            remoteViews.setViewVisibility(C0031R.id.text2, 0);
                            z4 = true;
                        } else {
                            remoteViews.setViewVisibility(C0031R.id.text2, 8);
                            z4 = false;
                    ...
                    if (z4 && Build.VERSION.SDK_INT >= 16) {
                        if (z2) {
                            remoteViews.setTextViewTextSize(C0031R.id.text, 0, resources.getDimensionPixelSize(C0031R.dimen.notification_subtext_size));
                        }
                        remoteViews.setViewPadding(C0031R.id.line1, 0, 0, 0, 0);
                    }
                    if (this.mBuilder.getWhenIfShowing() != 0) {
                        if (!this.mBuilder.mUseChronometer || Build.VERSION.SDK_INT < 16) {
                            remoteViews.setViewVisibility(C0031R.id.time, 0);
                            remoteViews.setLong(C0031R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                        } else {
                            remoteViews.setViewVisibility(C0031R.id.chronometer, 0);
                            remoteViews.setLong(C0031R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                            remoteViews.setBoolean(C0031R.id.chronometer, "setStarted", true);
                        }
                        z6 = true;
                    }
                    remoteViews.setViewVisibility(C0031R.id.right_side, !z6 ? 0 : 8);
                    remoteViews.setViewVisibility(C0031R.id.line3, z3 ? 0 : 8);
                    return remoteViews;
                }
                if (this.mBuilder.mNumber > resources.getInteger(C0031R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C0031R.id.info, resources.getString(C0031R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C0031R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C0031R.id.info, 0);
            }
            z3 = true;
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) {
            ...
            remoteViews.removeAllViews(C0031R.id.notification_main_column);
            remoteViews.addView(C0031R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C0031R.id.notification_main_column, 0);
            if (Build.VERSION.SDK_INT >= 21) {
                remoteViews.setViewPadding(C0031R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
            }
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m1590clone() {
            WearableExtender wearableExtender = new WearableExtender();
