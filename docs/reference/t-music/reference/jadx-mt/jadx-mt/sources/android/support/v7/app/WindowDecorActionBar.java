...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public class ActionModeImpl extends ActionMode implements MenuBuilder.Callback {
        ...
        public void finish() {
            ...
            if (WindowDecorActionBar.checkShowingFlags(windowDecorActionBar.mHiddenByApp, windowDecorActionBar.mHiddenBySystem, WindowDecorActionBar.$assertionsDisabled)) {
    ...
    private void init(View view) {
        this.mOverlayLayout = (ActionBarOverlayLayout) view.findViewById(C0443R.id.decor_content_parent);
        ActionBarOverlayLayout actionBarOverlayLayout = this.mOverlayLayout;
        if (actionBarOverlayLayout != null) {
            actionBarOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0443R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0443R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) view.findViewById(C0443R.id.action_bar_container);
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0443R.styleable.ActionBar, C0443R.attr.actionBarStyle, 0);
        if (typedArrayObtainStyledAttributes.getBoolean(C0443R.styleable.ActionBar_hideOnContentScroll, $assertionsDisabled)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0443R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0443R.attr.actionBarWidgetTheme, typedValue, true);
