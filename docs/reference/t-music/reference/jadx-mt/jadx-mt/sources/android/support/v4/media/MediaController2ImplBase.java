...
class MediaController2ImplBase implements MediaController2.SupportLibraryImpl {
    ...
    MediaController2ImplBase(Context context, MediaController2 mediaController2, SessionToken2 sessionToken2, Executor executor, MediaController2.ControllerCallback controllerCallback) {
        ...
        IMediaSession2 iMediaSession2AsInterface = IMediaSession2.Stub.asInterface((IBinder) this.mToken.getBinder());
        if (this.mToken.getType() == 0) {
            this.mServiceConnection = null;
            connectToSession(iMediaSession2AsInterface);
        } else {
    ...
    IMediaSession2 getSessionInterfaceIfAble(int i) {
        synchronized (this.mLock) {
    ...
    void notifyBufferingStateChanged(final MediaItem2 mediaItem2, final int i, long j) {
        synchronized (this.mLock) {
    ...
    void notifyError(final int i, final Bundle bundle) {
    ...
    void notifyRepeatModeChanges(final int i) {
        synchronized (this.mLock) {
            this.mRepeatMode = i;
        }
    ...
    void notifyShuffleModeChanges(final int i) {
        synchronized (this.mLock) {
            this.mShuffleMode = i;
        }
    ...
    void onConnectedNotLocked(IMediaSession2 iMediaSession2, final SessionCommandGroup2 sessionCommandGroup2, int i, MediaItem2 mediaItem2, long j, long j2, float f, long j3, MediaController2.PlaybackInfo playbackInfo, int i2, int i3, List<MediaItem2> list, PendingIntent pendingIntent) {
        if (DEBUG) {
