...
public class MediaSessionCompat {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromBundle(Bundle bundle) {
            ...
            SessionToken2 sessionToken2FromBundle = SessionToken2.fromBundle(bundle.getBundle(MediaSessionCompat.KEY_SESSION_TOKEN2));
            Token token = (Token) bundle.getParcelable(MediaSessionCompat.KEY_TOKEN);
            if (token == null) {
                return null;
            }
            return new Token(token.mInner, iMediaSessionAsInterface, sessionToken2FromBundle);
        }
