    ...
    private int parseC1(byte[] bArr, int i) {
        ...
        switch (i3) {
            ...
            case 144:
                ...
                int i15 = bArr[i13] & 7;
                i2 = i + 2;
                emitCaptionEvent(new CaptionEvent(12, new CaptionPenAttr(i11, i12, i10, i15, i14, z2, z)));
                break;
            case Const.CODE_C1_SPC /* 145 */:
                CaptionColor captionColor = new CaptionColor((bArr[i] & 192) >> 6, (bArr[i] & 48) >> 4, (bArr[i] & 12) >> 2, bArr[i] & 3);
                int i16 = i + 1;
                CaptionColor captionColor2 = new CaptionColor((bArr[i16] & 192) >> 6, (bArr[i16] & 48) >> 4, (bArr[i16] & 12) >> 2, bArr[i16] & 3);
                int i17 = i16 + 1;
                CaptionColor captionColor3 = new CaptionColor(0, (bArr[i17] & 48) >> 4, (bArr[i17] & 12) >> 2, bArr[i17] & 3);
                i2 = i17 + 1;
