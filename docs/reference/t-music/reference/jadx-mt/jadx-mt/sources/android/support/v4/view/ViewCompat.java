...
public class ViewCompat {
    ...
    static class UnhandledKeyEventManager {
        ...
        static UnhandledKeyEventManager m78at(View view) {
            UnhandledKeyEventManager unhandledKeyEventManager = (UnhandledKeyEventManager) view.getTag(C0031R.id.tag_unhandled_key_event_manager);
            if (unhandledKeyEventManager != null) {
                return unhandledKeyEventManager;
            }
            UnhandledKeyEventManager unhandledKeyEventManager2 = new UnhandledKeyEventManager();
            view.setTag(C0031R.id.tag_unhandled_key_event_manager, unhandledKeyEventManager2);
        ...
        boolean dispatch(View view, KeyEvent keyEvent) {
            ...
            if (viewDispatchInOrder != null) {
                this.mCurrentReceiver = new WeakReference<>(viewDispatchInOrder);
            }
        ...
        boolean onUnhandledKeyEvent(@NonNull View view, @NonNull KeyEvent keyEvent) {
            ArrayList arrayList = (ArrayList) view.getTag(C0031R.id.tag_unhandled_key_listeners);
            if (arrayList == null) {
                return false;
            }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        if (BuildCompat.isAtLeastP()) {
            Map arrayMap = (Map) view.getTag(C0031R.id.tag_unhandled_key_listeners);
            if (arrayMap == null) {
                arrayMap = new ArrayMap();
                view.setTag(C0031R.id.tag_unhandled_key_listeners, arrayMap);
            }
        ...
        if (arrayList == null) {
            ...
            view.setTag(C0031R.id.tag_unhandled_key_listeners, arrayList);
        }
    ...
    public static boolean dispatchUnhandledKeyEventPre(View view, KeyEvent keyEvent) {
        return !BuildCompat.isAtLeastP() && UnhandledKeyEventManager.m78at(view).hasFocus() && UnhandledKeyEventManager.m78at(view).dispatch(view, keyEvent);
    }
    ...
    public static void removeOnUnhandledKeyEventListener(@NonNull View view, @NonNull OnUnhandledKeyEventListenerCompat onUnhandledKeyEventListenerCompat) {
        ...
        if (BuildCompat.isAtLeastP()) {
            Map map = (Map) view.getTag(C0031R.id.tag_unhandled_key_listeners);
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, m72to = 1.0d) float f) {
        view.setAlpha(f);
    }
