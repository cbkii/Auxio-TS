...
/* JADX INFO: renamed from: d.a.a.a.v */
            ...
            if (((z && this.f1332Wn.m1571ae()) || this.f1332Wn.m1568_d()) && i2 == i3) {
                ...
                for (int i7 = 0; i7 < this.mItems; i7++) {
                    ...
                    if (abstractC0816lArr[iArr[i7]] != null && !this.f1330Un[iArr[i7]].charset().equals("Big5")) {
                        float fM1569a = this.f1332Wn.m1569a(this.f1331Vn[this.f1333Xn[i7]].mo1560be(), this.f1331Vn[this.f1333Xn[i7]].mo1561ce(), this.f1331Vn[this.f1333Xn[i7]].mo1562de(), this.f1331Vn[this.f1333Xn[i7]].mo1563ee());
                        int i8 = i6 + 1;
                        if (i6 == 0 || f > fM1569a) {
                            i5 = i7;
                            f = fM1569a;
    ...
    public boolean m1578i(byte[] bArr, int i) {
        ...
        loop0: while (i2 < i) {
            ...
            while (true) {
                ...
                byte bM1555a = AbstractC0804A.m1555a(this.f1330Un[this.f1333Xn[i3]], b2, this.mState[i3]);
                if (bM1555a == 2) {
