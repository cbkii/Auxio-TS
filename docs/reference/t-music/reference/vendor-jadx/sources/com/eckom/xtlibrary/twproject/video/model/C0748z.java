...
/* renamed from: com.eckom.xtlibrary.twproject.video.model.z */
...
public class C0748z<P extends AbstractC0658a> extends BaseVideoMode {
    ...
    /* compiled from: VideoModel.java */
    /* renamed from: com.eckom.xtlibrary.twproject.video.model.z$a */
    ...
    public void m1261F(boolean z) {
        ...
        try {
            ...
            Log.w("VideoModel", "showMultiScreen:" + e.getMessage());
        }
            ...
            if (this.f961Wi != null) {
                ...
                if (!this.f961Wi.m1294pa()) {
                    ...
                    try {
                        ...
                        Log.d("VideoModel", Log.getStackTraceString(e2));
                    }
                }
