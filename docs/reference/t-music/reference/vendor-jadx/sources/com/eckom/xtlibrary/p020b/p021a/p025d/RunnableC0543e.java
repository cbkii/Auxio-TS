...
/* renamed from: com.eckom.xtlibrary.b.a.d.e */
...
class RunnableC0543e implements Runnable {
    ...
    public void run() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                try {
                    ...
                    String m1131eb = tWContact.m1131eb();
                    if (m1131eb != null && m1131eb.length() > 0) {
                        arrayList.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI).withValueBackReference("raw_contact_id", size2).withValue("mimetype", "vnd.android.cursor.item/phone_v2").withValue("data1", m1131eb).withValue("data2", this.this$0.f425la.f409yg).withYieldAllowed(true).build());
                    }
                } catch (Exception e4) {
                    e = e4;
                    try {
        ...
        try {
                ...
                while (true) {
                    ...
                    try {
                        try {
                            ...
                            String m1131eb2 = tWContact2.m1131eb();
                            if (m1131eb2 != null && m1131eb2.length() > 0) {
                                try {
                                    arrayList2.add(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI).withValueBackReference("raw_contact_id", size).withValue("mimetype", "vnd.android.cursor.item/phone_v2").withValue("data1", m1131eb2).withValue("data2", this.this$0.f425la.f409yg).withYieldAllowed(true).build());
                                } catch (Exception e10) {
                                    e = e10;
                                    e.printStackTrace();
                                    i3 = i14;
            ...
            Log.e("tssDebug", "共耗时：" + (currentTimeMillis2 - j));
        } catch (Exception e14) {
            e = e14;
        }
    }
