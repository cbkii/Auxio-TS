...
public class FontResourcesParserCompat {
    ...
    private static FamilyResourceEntry readFamily(XmlPullParser xmlPullParser, Resources resources) {
        ...
        int integer2 = obtainAttributes.getInteger(C0031R.styleable.FontFamily_fontProviderFetchTimeout, DEFAULT_TIMEOUT_MILLIS);
    ...
    private static FontFileResourceEntry readFont(XmlPullParser xmlPullParser, Resources resources) {
        ...
        int i = obtainAttributes.getInt(obtainAttributes.hasValue(C0031R.styleable.FontFamilyFont_fontWeight) ? C0031R.styleable.FontFamilyFont_fontWeight : C0031R.styleable.FontFamilyFont_android_fontWeight, NORMAL_WEIGHT);
