    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) {
        ...
        while (true) {
            ...
            if (next == 2 && depth <= depth2 && xmlPullParser.getName().equals("item")) {
                TypedArray obtainAttributes = obtainAttributes(resources, theme, attributeSet, C0443R.styleable.ColorStateListItem);
                int color = obtainAttributes.getColor(C0443R.styleable.ColorStateListItem_android_color, -65281);
                float f = 1.0f;
                if (obtainAttributes.hasValue(C0443R.styleable.ColorStateListItem_android_alpha)) {
                    f = obtainAttributes.getFloat(C0443R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (obtainAttributes.hasValue(C0443R.styleable.ColorStateListItem_alpha)) {
                    f = obtainAttributes.getFloat(C0443R.styleable.ColorStateListItem_alpha, 1.0f);
                }
