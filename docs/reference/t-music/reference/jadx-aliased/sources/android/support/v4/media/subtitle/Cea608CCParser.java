...
class Cea608CCParser {
    ...
    /* renamed from: BS */
    private static final int f244BS = 33;

    /* renamed from: CR */
    private static final int f245CR = 45;
    ...
    /* renamed from: TR */
    private static final int f246TR = 42;

    /* renamed from: TS */
    private static final char f247TS = 160;
    ...
    private static class CCData {
        ...
        private String getExtendedChar() {
            ...
            byte b5 = this.mData1;
            if ((b5 == 19 || b5 == 27) && (b3 = this.mData2) >= 32 && b3 <= 63) {
    ...
    private static class CCMemory {
        ...
        CCMemory() {
            ...
            Arrays.fill(cArr, Cea608CCParser.f247TS);
        ...
        void m74bs() {
            ...
            int i = this.mRow;
            if (cCLineBuilderArr[i] != null) {
                cCLineBuilderArr[i].setCharAt(this.mCol, Cea608CCParser.f247TS);
                if (this.mCol == 31) {
                    this.mLines[this.mRow].setCharAt(32, Cea608CCParser.f247TS);
                }
            }
        }
                ...
                for (int i = 0; i < this.mCol; i++) {
                    if (this.mLines[this.mRow].charAt(i) != 160) {
                        for (int i2 = this.mCol; i2 < this.mLines[this.mRow].length(); i2++) {
                            this.mLines[i2].setCharAt(i2, Cea608CCParser.f247TS);
                        }
                        return;
                    }
                }
