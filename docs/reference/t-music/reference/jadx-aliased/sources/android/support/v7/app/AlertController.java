...
class AlertController {
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController alertController) {
            ...
            if (this.mIsMultiChoice) {
                ...
                listAdapter = cursor == null ? new ArrayAdapter<CharSequence>(this.mContext, alertController.mMultiChoiceItemLayout, R.id.text1, this.mItems) { // from class: android.support.v7.app.AlertController.AlertParams.1
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0443R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0443R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0443R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(null, C0443R.styleable.AlertDialog, C0443R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0443R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0443R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0443R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0443R.id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0443R.id.scrollIndicatorDown);
    ...
    private void setupView() {
        ...
        ListAdapter listAdapter;
        View findViewById2;
        View findViewById3 = this.mWindow.findViewById(C0443R.id.parentPanel);
        View findViewById4 = findViewById3.findViewById(C0443R.id.topPanel);
        View findViewById5 = findViewById3.findViewById(C0443R.id.contentPanel);
        View findViewById6 = findViewById3.findViewById(C0443R.id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById3.findViewById(C0443R.id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById7 = viewGroup.findViewById(C0443R.id.topPanel);
        View findViewById8 = viewGroup.findViewById(C0443R.id.contentPanel);
        View findViewById9 = viewGroup.findViewById(C0443R.id.buttonPanel);
        ...
        if (!z3 && resolvePanel2 != null && (findViewById2 = resolvePanel2.findViewById(C0443R.id.textSpacerNoButtons)) != null) {
        ...
        if (z2 != 0) {
            ...
            View findViewById10 = (this.mMessage == null && this.mListView == null) ? null : resolvePanel.findViewById(C0443R.id.titleDividerNoCustom);
            if (findViewById10 != null) {
                findViewById10.setVisibility(0);
            }
        } else if (resolvePanel2 != null && (findViewById = resolvePanel2.findViewById(C0443R.id.textSpacerNoTitle)) != null) {
