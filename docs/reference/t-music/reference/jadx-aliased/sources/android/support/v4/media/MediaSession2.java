...
public class MediaSession2 implements MediaInterface2.SessionPlayer, AutoCloseable {
    ...
    public static final class Builder extends BuilderBase<MediaSession2, Builder, SessionCallback> {
        ...
        /* JADX WARN: Type inference failed for: r0v3, types: [C extends android.support.v4.media.MediaSession2$SessionCallback, android.support.v4.media.MediaSession2$Builder$1] */
    ...
    static abstract class BuilderBase<T extends MediaSession2, U extends BuilderBase<T, U, C>, C extends SessionCallback> {
        ...
        @NonNull
        U setPlayer(@NonNull BaseMediaPlayer baseMediaPlayer) {
        ...
        U setPlaylistAgent(@NonNull MediaPlaylistAgent mediaPlaylistAgent) {
        ...
        @NonNull
        U setSessionActivity(@Nullable PendingIntent pendingIntent) {
            this.mSessionActivity = pendingIntent;
            return this;
        }

        @NonNull
        U setSessionCallback(@NonNull Executor executor, @NonNull C c2) {
            if (executor == null) {
        ...
        @NonNull
        U setVolumeProvider(@Nullable VolumeProviderCompat volumeProviderCompat) {
    ...
    static abstract class ControllerCb {
        ...
        abstract void onAllowedCommandsChanged(@NonNull SessionCommandGroup2 sessionCommandGroup2);

        abstract void onBufferingStateChanged(@NonNull MediaItem2 mediaItem2, int i, long j);

        abstract void onChildrenChanged(@NonNull String str, int i, @Nullable Bundle bundle);

        abstract void onCurrentMediaItemChanged(@Nullable MediaItem2 mediaItem2);

        abstract void onCustomCommand(@NonNull SessionCommand2 sessionCommand2, @Nullable Bundle bundle, @Nullable ResultReceiver resultReceiver);

        abstract void onCustomLayoutChanged(@NonNull List<CommandButton> list);

        abstract void onDisconnected();

        abstract void onError(int i, @Nullable Bundle bundle);

        abstract void onGetChildrenDone(@NonNull String str, int i, int i2, @Nullable List<MediaItem2> list, @Nullable Bundle bundle);

        abstract void onGetItemDone(@NonNull String str, @Nullable MediaItem2 mediaItem2);

        abstract void onGetLibraryRootDone(@Nullable Bundle bundle, @Nullable String str, @Nullable Bundle bundle2);

        abstract void onGetSearchResultDone(@NonNull String str, int i, int i2, @Nullable List<MediaItem2> list, @Nullable Bundle bundle);

        abstract void onPlaybackInfoChanged(@NonNull MediaController2.PlaybackInfo playbackInfo);

        abstract void onPlaybackSpeedChanged(long j, long j2, float f);

        abstract void onPlayerStateChanged(long j, long j2, int i);

        abstract void onPlaylistChanged(@NonNull List<MediaItem2> list, @Nullable MediaMetadata2 mediaMetadata2);

        abstract void onPlaylistMetadataChanged(@Nullable MediaMetadata2 mediaMetadata2);

        abstract void onRepeatModeChanged(int i);

        abstract void onRoutesInfoChanged(@Nullable List<Bundle> list);

        abstract void onSearchResultChanged(@NonNull String str, int i, @Nullable Bundle bundle);

        abstract void onSeekCompleted(long j, long j2, long j3);

        abstract void onShuffleModeChanged(int i);
    }
