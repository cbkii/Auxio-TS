...
public final class ColorUtils {
    ...
    @ColorInt
    public static int LABToColor(@FloatRange(from = 0.0d, m72to = 100.0d) double d2, @FloatRange(from = -128.0d, m72to = 127.0d) double d3, @FloatRange(from = -128.0d, m72to = 127.0d) double d4) {
        double[] tempDouble3Array = getTempDouble3Array();
        LABToXYZ(d2, d3, d4, tempDouble3Array);
        return XYZToColor(tempDouble3Array[0], tempDouble3Array[1], tempDouble3Array[2]);
    }

    public static void LABToXYZ(@FloatRange(from = 0.0d, m72to = 100.0d) double d2, @FloatRange(from = -128.0d, m72to = 127.0d) double d3, @FloatRange(from = -128.0d, m72to = 127.0d) double d4, @NonNull double[] dArr) {
    ...
    public static void RGBToHSL(@IntRange(from = 0, m73to = 255) int i, @IntRange(from = 0, m73to = 255) int i2, @IntRange(from = 0, m73to = 255) int i3, @NonNull float[] fArr) {
        float f;
        float abs;
        float f2 = i / 255.0f;
        float f3 = i2 / 255.0f;
    ...
    public static void RGBToLAB(@IntRange(from = 0, m73to = 255) int i, @IntRange(from = 0, m73to = 255) int i2, @IntRange(from = 0, m73to = 255) int i3, @NonNull double[] dArr) {
        RGBToXYZ(i, i2, i3, dArr);
        XYZToLAB(dArr[0], dArr[1], dArr[2], dArr);
    }

    public static void RGBToXYZ(@IntRange(from = 0, m73to = 255) int i, @IntRange(from = 0, m73to = 255) int i2, @IntRange(from = 0, m73to = 255) int i3, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int XYZToColor(@FloatRange(from = 0.0d, m72to = 95.047d) double d2, @FloatRange(from = 0.0d, m72to = 100.0d) double d3, @FloatRange(from = 0.0d, m72to = 108.883d) double d4) {
    ...
    public static void XYZToLAB(@FloatRange(from = 0.0d, m72to = 95.047d) double d2, @FloatRange(from = 0.0d, m72to = 100.0d) double d3, @FloatRange(from = 0.0d, m72to = 108.883d) double d4, @NonNull double[] dArr) {
        if (dArr.length != 3) {
    ...
    @ColorInt
    public static int setAlphaComponent(@ColorInt int i, @IntRange(from = 0, m73to = 255) int i2) {
        if (i2 < 0 || i2 > 255) {
