    ...
    */
    void moveToState(Fragment fragment, int i, int i2, int i3, boolean z) {
        ...
        if (fragment.mRemoving && i4 > (i7 = fragment.mState)) {
            i4 = (i7 == 0 && fragment.isInBackStack()) ? 1 : fragment.mState;
        }
            ...
            if (i11 != 0) {
                ...
                if (fragment3 != null) {
                    ...
                    if (fragment5.mState < 1) {
                        ...
                        if (fragment.mCalled) {
                            throw new SuperNotCalledException(str + fragment + " did not call through to super.onAttach()");
                        }
                ...
                if (!fragment.mFromLayout) {
                    ...
                    if (i12 == 0) {
                        ...
                        if (viewGroup2 == null && !fragment.mRestored) {
                            try {
                                str2 = fragment.getResources().getResourceName(fragment.mContainerId);
                            } catch (Resources.NotFoundException unused) {
                                str2 = "unknown";
                            }
                            throwException(new IllegalArgumentException("No view found for id 0x" + Integer.toHexString(fragment.mContainerId) + " (" + str2 + ") for fragment " + fragment));
                            throw null;
                        }
                    }
