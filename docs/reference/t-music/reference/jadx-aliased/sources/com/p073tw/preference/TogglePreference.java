...
public class TogglePreference extends LinearLayout {
    ...
    /* renamed from: com.tw.preference.TogglePreference$a */
    ...
    private void m1554a(AttributeSet attributeSet) {
        ...
        this.itemBackground = obtainStyledAttributes.getDrawable(R$styleable.TogglePreference_android_background);
        this.title = obtainStyledAttributes.getString(R$styleable.TogglePreference_android_text);
        this.titleTextSize = obtainStyledAttributes.getDimension(R$styleable.TogglePreference_android_textSize, getResources().getDimension(R$dimen.tw_dp_h32));
        ...
        this.f1241fe = obtainStyledAttributes.getDrawable(R$styleable.TogglePreference_rightIconBackground);
        this.paddingLeft = (int) obtainStyledAttributes.getDimension(R$styleable.TogglePreference_paddingLeft, getResources().getDimension(R$dimen.tw_dp_w64));
        this.paddingRight = (int) obtainStyledAttributes.getDimension(R$styleable.TogglePreference_paddingRight, getResources().getDimension(R$dimen.tw_dp_w64));
        this.rightIconWidth = (int) obtainStyledAttributes.getDimension(R$styleable.TogglePreference_rightIconWidth, getResources().getDimension(R$dimen.tw_dp_h120));
        this.rightIconHeight = (int) obtainStyledAttributes.getDimension(R$styleable.TogglePreference_rightIconHeight, getResources().getDimension(R$dimen.tw_dp_h70));
