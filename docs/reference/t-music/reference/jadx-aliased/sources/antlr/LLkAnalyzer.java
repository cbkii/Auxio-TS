...
public class LLkAnalyzer implements LLkGrammarAnalyzer {
    ...
    public Lookahead FOLLOW(int i, RuleEndElement ruleEndElement) {
        ...
        for (int i3 = 0; i3 < ruleSymbol.numReferences(); i3++) {
            ...
            if (this.DEBUG_ANALYZER) {
                ...
                StringBuilder m10b = C0000a.m10b("next[", ruleName, "] is ");
                m10b.append(reference.next.toString());
                printStream.println(m10b.toString());
            }
            Lookahead look = reference.next.look(i);
            if (this.DEBUG_ANALYZER) {
                PrintStream printStream2 = System.out;
                StringBuilder m10b2 = C0000a.m10b("FIRST of next[", ruleName, "] ptr is ");
                m10b2.append(look.toString());
                printStream2.println(m10b2.toString());
            }
            ...
            if (this.DEBUG_ANALYZER) {
                ...
                StringBuilder m10b3 = C0000a.m10b("combined FOLLOW[", ruleName, "] is ");
                m10b3.append(lookahead.toString());
                printStream3.println(m10b3.toString());
            }
        }
        ...
        while (i3 < size - 1) {
            ...
            while (i5 < size) {
                ...
                while (true) {
                    ...
                    if (this.DEBUG_ANALYZER) {
                        PrintStream printStream2 = System.out;
                        StringBuilder m5a = C0000a.m5a("p is ");
                        z = z3;
                        m5a.append(altLookahead.toString(",", this.charFormatter, this.grammar));
                        printStream2.println(m5a.toString());
                    } else {
                        z = z3;
                    }
                    if (this.DEBUG_ANALYZER) {
                        PrintStream printStream3 = System.out;
                        StringBuilder m5a2 = C0000a.m5a("q is ");
                        m5a2.append(altLookahead2.toString(",", this.charFormatter, this.grammar));
                        printStream3.println(m5a2.toString());
                    }
    ...
    public boolean deterministicImpliedPath(BlockWithImpliedExitPath blockWithImpliedExitPath) {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            while (true) {
                ...
                Lookahead look = blockWithImpliedExitPath.next.look(i3);
                blockWithImpliedExitPath.exitCache[i3] = look;
                this.currentBlock.alti = i2;
                Lookahead altLookahead = getAltLookahead(blockWithImpliedExitPath, i2, i3);
                if (this.DEBUG_ANALYZER) {
                    PrintStream printStream = System.out;
                    StringBuilder m5a = C0000a.m5a("follow is ");
                    m5a.append(look.toString(",", this.charFormatter, this.grammar));
                    printStream.println(m5a.toString());
                }
                if (this.DEBUG_ANALYZER) {
                    PrintStream printStream2 = System.out;
                    StringBuilder m5a2 = C0000a.m5a("p is ");
                    m5a2.append(altLookahead.toString(",", this.charFormatter, this.grammar));
    ...
    public Lookahead look(int i, BlockEndElement blockEndElement) {
        ...
        if (alternativeBlock2 instanceof TreeElement) {
            look2 = Lookahead.m109of(3);
        } else {
            if (alternativeBlock2 instanceof SynPredBlock) {
                look.setEpsilon();
                return look;
            }
            look2 = alternativeBlock2.next.look(i);
        }
    ...
    public Lookahead look(int i, CharLiteralElement charLiteralElement) {
        ...
        if (this.DEBUG_ANALYZER) {
            PrintStream printStream = System.out;
            StringBuilder m5a = C0000a.m5a("charVocab is ");
            m5a.append(bitSet.toString());
            printStream.println(m5a.toString());
        }
        removeCompetingPredictionSets(bitSet, charLiteralElement);
        if (this.DEBUG_ANALYZER) {
            PrintStream printStream2 = System.out;
            StringBuilder m5a2 = C0000a.m5a("charVocab after removal of prior alt lookahead ");
            m5a2.append(bitSet.toString());
            printStream2.println(m5a2.toString());
        }
    ...
    public Lookahead look(int i, CharRangeElement charRangeElement) {
        ...
        BitSet m114of = BitSet.m114of(charRangeElement.begin);
        for (int i2 = charRangeElement.begin + 1; i2 <= charRangeElement.end; i2++) {
            m114of.add(i2);
        }
        return new Lookahead(m114of);
    }
    ...
    public Lookahead look(int i, GrammarAtom grammarAtom) {
        ...
        Lookahead m109of = Lookahead.m109of(grammarAtom.getType());
        if (grammarAtom.not) {
            m109of.fset.notInPlace(4, this.grammar.tokenManager.maxTokenType());
            removeCompetingPredictionSets(m109of.fset, grammarAtom);
        }
        return m109of;
    }
    ...
    public Lookahead look(int i, RuleRefElement ruleRefElement) {
        ...
        if (ruleSymbol == null || !ruleSymbol.defined) {
            Tool tool = this.tool;
            StringBuilder m5a = C0000a.m5a("no definition of rule ");
            m5a.append(ruleRefElement.targetRule);
            tool.error(m5a.toString(), this.grammar.getFilename(), ruleRefElement.getLine(), ruleRefElement.getColumn());
            return new Lookahead();
        }
        ...
        if (this.DEBUG_ANALYZER) {
            PrintStream printStream = System.out;
            StringBuilder m5a2 = C0000a.m5a("back from rule ref to ");
        ...
        if (look.cycle != null) {
            ...
            StringBuilder m5a3 = C0000a.m5a("infinite recursion to rule ");
            m5a3.append(look.cycle);
            m5a3.append(" from rule ");
            m5a3.append(ruleRefElement.enclosingRuleName);
            tool2.error(m5a3.toString(), this.grammar.getFilename(), ruleRefElement.getLine(), ruleRefElement.getColumn());
        }
        if (look.containsEpsilon()) {
            if (this.DEBUG_ANALYZER) {
                PrintStream printStream2 = System.out;
                StringBuilder m5a4 = C0000a.m5a("rule ref to ");
                m5a4.append(ruleRefElement.targetRule);
                m5a4.append(" has eps, depth: ");
                m5a4.append(look.epsilonDepth);
                printStream2.println(m5a4.toString());
            }
            look.resetEpsilon();
    ...
    public Lookahead look(int i, StringLiteralElement stringLiteralElement) {
        ...
        Lookahead m109of = Lookahead.m109of(stringLiteralElement.getType());
    ...
    public Lookahead look(int i, TokenRangeElement tokenRangeElement) {
        ...
        BitSet m114of = BitSet.m114of(tokenRangeElement.begin);
    ...
    public Lookahead look(int i, String str) {
        ...
        if (zArr[i]) {
            if (this.DEBUG_ANALYZER) {
                PrintStream printStream = System.out;
                StringBuilder m5a = C0000a.m5a("infinite recursion to rule ");
                m5a.append(block.getRuleName());
                printStream.println(m5a.toString());
            }
    ...
    public boolean subruleCanBeInverted(AlternativeBlock alternativeBlock, boolean z) {
        ...
        for (0; i < alternativeBlock.alternatives.size(); i + 1) {
            Alternative alternativeAt = alternativeBlock.getAlternativeAt(i);
