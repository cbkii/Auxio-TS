...
public class DocBookCodeGenerator extends CodeGenerator {
    ...
    public void gen(LexerGrammar lexerGrammar) {
        ...
        StringBuilder m5a2 = C0000a.m5a("<para>Definition of lexer ");
        C0000a.m4a(this.grammar, m5a2, ", which is a subclass of ");
    ...
    public void gen(ParserGrammar parserGrammar) {
        ...
        StringBuilder m5a2 = C0000a.m5a("<para>Definition of parser ");
        C0000a.m4a(this.grammar, m5a2, ", which is a subclass of ");
        m5a2.append(this.grammar.getSuperClass());
        m5a2.append(".</para>");
        println(m5a2.toString());
    ...
    public void gen(RuleRefElement ruleRefElement) {
        StringBuilder m5a = C0000a.m5a("<link linkend=\"");
        m5a.append(QuoteForId(ruleRefElement.targetRule));
        m5a.append("\">");
        _print(m5a.toString());
    ...
    public void gen(TreeWalkerGrammar treeWalkerGrammar) {
        ...
        StringBuilder m5a2 = C0000a.m5a("<para>Definition of tree parser ");
        C0000a.m4a(this.grammar, m5a2, ", which is a subclass of ");
        m5a2.append(this.grammar.getSuperClass());
        m5a2.append(".</para>");
        println(m5a2.toString());
    ...
    public void genRule(RuleSymbol ruleSymbol) {
        ...
        if (ruleSymbol.access.length() != 0 && !ruleSymbol.access.equals("public")) {
            StringBuilder m5a = C0000a.m5a("<para>");
            m5a.append(ruleSymbol.access);
            m5a.append(" </para>");
            _print(m5a.toString());
        }
        StringBuilder m5a2 = C0000a.m5a("<section id=\"");
        m5a2.append(QuoteForId(ruleSymbol.getId()));
        m5a2.append("\">");
        println(m5a2.toString());
        println("<title>" + ruleSymbol.getId() + "</title>");
        if (ruleSymbol.comment != null) {
            StringBuilder m5a3 = C0000a.m5a("<para>");
            m5a3.append(HTMLEncode(ruleSymbol.comment));
            m5a3.append("</para>");
            _println(m5a3.toString());
        }
        println("<para>");
