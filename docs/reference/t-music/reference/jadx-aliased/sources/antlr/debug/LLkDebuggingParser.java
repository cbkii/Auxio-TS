...
public class LLkDebuggingParser extends LLkParser implements DebuggingParser {
    ...
    public int mo107LA(int i) {
        int mo107LA = super.mo107LA(i);
        this.parserEventSupport.fireLA(i, mo107LA);
        return mo107LA;
    }
    ...
    public void consume() {
        ...
        super.consume();
        this.parserEventSupport.fireConsume(mo107LA);
    }
    ...
    public void match(int i) {
        ...
        try {
            ...
            if (i2 == 0) {
                this.parserEventSupport.fireMismatch(mo107LA, i, text, i2);
            }
            throw e;
        }
    }
    ...
    public void match(BitSet bitSet) {
        ...
        try {
            super.match(bitSet);
            this.parserEventSupport.fireMatch(mo107LA, bitSet, text, this.inputState.guessing);
        } catch (MismatchedTokenException e) {
            int i = this.inputState.guessing;
            if (i == 0) {
                this.parserEventSupport.fireMismatch(mo107LA, bitSet, text, i);
            }
            throw e;
        }
    }
    ...
    public void matchNot(int i) {
        ...
        try {
            super.matchNot(i);
            this.parserEventSupport.fireMatchNot(mo107LA, i, text, this.inputState.guessing);
        } catch (MismatchedTokenException e) {
            int i2 = this.inputState.guessing;
            if (i2 == 0) {
                this.parserEventSupport.fireMismatchNot(mo107LA, i, text, i2);
            }
            throw e;
        }
    }
