...
public class ParserMatchEvent extends GuessingEvent {
    ...
    public String toString() {
        StringBuilder m5a = C0000a.m5a("ParserMatchEvent [");
        m5a.append(isMatched() ? "ok," : "bad,");
        m5a.append(isInverse() ? "NOT " : "");
        m5a.append(getType() == TOKEN ? "token," : "bitset,");
        m5a.append(getValue());
        m5a.append(",");
        m5a.append(getTarget());
        m5a.append(",");
