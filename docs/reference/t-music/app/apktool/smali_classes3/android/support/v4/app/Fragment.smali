...
.field mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/l;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private mViewLifecycleRegistry:Landroid/arch/lifecycle/g;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/l;
...
.method static synthetic access$900(Landroid/support/v4/app/Fragment;)Landroid/arch/lifecycle/g;
    .locals 0

    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/g;

    return-object p0
.end method

.method static synthetic access$902(Landroid/support/v4/app/Fragment;Landroid/arch/lifecycle/g;)Landroid/arch/lifecycle/g;
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/g;
...
.method public getLifecycle()Landroid/arch/lifecycle/Lifecycle;
    ...
    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mLifecycleRegistry:Landroid/arch/lifecycle/g;
...
.method public getViewLifecycleOwner()Landroid/arch/lifecycle/e;
    ...
    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/e;
...
.method public getViewLifecycleOwnerLiveData()Landroid/arch/lifecycle/LiveData;
    ...
    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/l;
...
.method public getViewModelStore()Landroid/arch/lifecycle/q;
    ...
    .line 4
    :cond_0
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewModelStore:Landroid/arch/lifecycle/q;
...
.method public onDestroyView()V
    ...
    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/g;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public onViewStateRestored(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Landroid/arch/lifecycle/g;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method performCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)V
    ...
    .line 5
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/g;
    ...
    .line 9
    iget-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/l;

    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/e;

    invoke-virtual {p1, p0}, Landroid/arch/lifecycle/l;->setValue(Ljava/lang/Object;)V

    goto :goto_0

    .line 10
    :cond_1
    iget-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/g;
...
.method performDestroy()V
    ...
    invoke-virtual {v0, v1}, Landroid/arch/lifecycle/g;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method performPause()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/g;
