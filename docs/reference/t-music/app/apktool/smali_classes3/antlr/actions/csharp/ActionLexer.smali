...
.method public final mID(Z)V
    ...
    sget-object v5, Lantlr/actions/csharp/ActionLexer;->_tokenSet_9:Lantlr/collections/impl/BitSet;
...
.method public final mID_ELEMENT(Z)Z
    ...
    sget-object v4, Lantlr/actions/csharp/ActionLexer;->_tokenSet_14:Lantlr/collections/impl/BitSet;
    ...
    invoke-virtual {v0, v6}, Lantlr/actions/csharp/ActionLexer;->mWS(Z)V
    ...
    invoke-virtual {v0, v11}, Lantlr/CharScanner;->LA(I)C
    ...
    iget-object v7, v0, Lantlr/actions/csharp/ActionLexer;->transInfo:Lantlr/ActionTransInfo;
    ...
    sget-object v3, Lantlr/actions/csharp/ActionLexer;->_tokenSet_16:Lantlr/collections/impl/BitSet;
    ...
    :goto_1
    invoke-virtual {v0, v6}, Lantlr/actions/csharp/ActionLexer;->mVAR_ASSIGN(Z)V
    ...
    :cond_a
    :pswitch_0
    invoke-virtual {v0, v6}, Lantlr/actions/csharp/ActionLexer;->mARG(Z)V
    ...
    :goto_4
    invoke-virtual {v0, v6}, Lantlr/actions/csharp/ActionLexer;->mID_ELEMENT(Z)Z
    ...
    invoke-virtual {v5, v3}, Lantlr/ANTLRStringBuffer;->setLength(I)V
...
.method public final mSTUFF(Z)V
    ...
    sget-object v1, Lantlr/actions/csharp/ActionLexer;->_tokenSet_1:Lantlr/collections/impl/BitSet;
    ...
    sget-object v1, Lantlr/actions/csharp/ActionLexer;->_tokenSet_2:Lantlr/collections/impl/BitSet;
...
.method public final mTEXT_ARG(Z)V
    ...
    :cond_0
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mWS(Z)V
    ...
    :goto_0
    sget-object v5, Lantlr/actions/csharp/ActionLexer;->_tokenSet_11:Lantlr/collections/impl/BitSet;
    ...
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mTEXT_ARG_ELEMENT(Z)V
    ...
    :cond_2
    sget-object v5, Lantlr/actions/csharp/ActionLexer;->_tokenSet_12:Lantlr/collections/impl/BitSet;
...
.method public final mTEXT_ARG_ELEMENT(Z)V
    ...
    :pswitch_0
    invoke-virtual {p0, v3}, Lantlr/actions/csharp/ActionLexer;->mINT_OR_FLOAT(Z)V

    goto :goto_0

    :cond_0
    :pswitch_1
    invoke-virtual {p0, v3}, Lantlr/actions/csharp/ActionLexer;->mTEXT_ARG_ID_ELEMENT(Z)V
    ...
    :cond_2
    invoke-virtual {p0, v3}, Lantlr/actions/csharp/ActionLexer;->mCHAR(Z)V

    goto :goto_0

    :cond_3
    invoke-virtual {p0, v3}, Lantlr/actions/csharp/ActionLexer;->mTEXT_ITEM(Z)V
...
.method public final mTEXT_ARG_ID_ELEMENT(Z)V
    ...
    sget-object v2, Lantlr/actions/csharp/ActionLexer;->_tokenSet_22:Lantlr/collections/impl/BitSet;
    ...
    :goto_2
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mTEXT_ARG(Z)V
    ...
    sget-object v12, Lantlr/actions/csharp/ActionLexer;->_tokenSet_4:Lantlr/collections/impl/BitSet;
    ...
    sget-object v12, Lantlr/actions/csharp/ActionLexer;->_tokenSet_24:Lantlr/collections/impl/BitSet;
...
.method public final mTEXT_ITEM(Z)V
    ...
    :cond_1
    invoke-virtual {v0, v11}, Lantlr/actions/csharp/ActionLexer;->mWS(Z)V
    ...
    invoke-virtual {v0, v9}, Lantlr/CharScanner;->match(C)V
    ...
    :goto_1
    iget-object v3, v0, Lantlr/actions/csharp/ActionLexer;->currentRule:Lantlr/RuleBlock;
    ...
    const-string v5, "text.Length = _begin; text.Append("
...
.method public final mTREE(Z)V
    ...
    invoke-virtual {v0, v14}, Lantlr/actions/csharp/ActionLexer;->mWS(Z)V
    ...
    iget-object v10, v0, Lantlr/actions/csharp/ActionLexer;->generator:Lantlr/CodeGenerator;

    invoke-virtual {v5}, Lantlr/Token;->getText()Ljava/lang/String;

    move-result-object v5

    invoke-virtual {v10, v5}, Lantlr/CodeGenerator;->processStringForASTConstructor(Ljava/lang/String;)Ljava/lang/String;
...
.method public final mTREE_ELEMENT(Z)V
    ...
    :goto_0
    :pswitch_0
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mAST_CONSTRUCTOR(Z)V
    ...
    :cond_5
    :pswitch_1
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mID_ELEMENT(Z)Z

    goto :goto_3

    :cond_6
    :goto_2
    invoke-virtual {p0, v4}, Lantlr/actions/csharp/ActionLexer;->mTREE(Z)V
...
.method public reportWarning(Ljava/lang/String;)V
    ...
    iget-object p0, p0, Lantlr/actions/csharp/ActionLexer;->antlrTool:Lantlr/Tool;
