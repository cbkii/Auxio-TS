...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Landroid/arch/lifecycle/j;-><init>(Landroid/arch/lifecycle/LiveData;)V
...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Landroid/arch/core/a/c;->ua()Z
...
.method private considerNotify(Landroid/arch/lifecycle/LiveData$b;)V
    ...
    .line 1
    iget-boolean v0, p1, Landroid/arch/lifecycle/LiveData$b;->mActive:Z
    ...
    .line 2
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/LiveData$b;->ya()Z
    ...
    .line 3
    invoke-virtual {p1, p0}, Landroid/arch/lifecycle/LiveData$b;->y(Z)V

    return-void

    .line 4
    :cond_1
    iget v0, p1, Landroid/arch/lifecycle/LiveData$b;->Ma:I
    ...
    .line 5
    :cond_2
    iput v1, p1, Landroid/arch/lifecycle/LiveData$b;->Ma:I

    .line 6
    iget-object p1, p1, Landroid/arch/lifecycle/LiveData$b;->mObserver:Landroid/arch/lifecycle/m;

    iget-object p0, p0, Landroid/arch/lifecycle/LiveData;->mData:Ljava/lang/Object;

    invoke-interface {p1, p0}, Landroid/arch/lifecycle/m;->onChanged(Ljava/lang/Object;)V
...
.method private dispatchingValue(Landroid/arch/lifecycle/LiveData$b;)V
    ...
    .line 7
    invoke-virtual {v1}, Landroid/arch/core/b/c;->va()Landroid/arch/core/b/c$d;
...
.method public observe(Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/m;)V
    .locals 2
    ...
    invoke-direct {v0, p0, p1, p2}, Landroid/arch/lifecycle/LiveData$LifecycleBoundObserver;-><init>(Landroid/arch/lifecycle/LiveData;Landroid/arch/lifecycle/e;Landroid/arch/lifecycle/m;)V
    ...
    check-cast p0, Landroid/arch/lifecycle/LiveData$b;

    if-eqz p0, :cond_2

    .line 5
    invoke-virtual {p0, p1}, Landroid/arch/lifecycle/LiveData$b;->g(Landroid/arch/lifecycle/e;)Z
    ...
    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/Lifecycle;->a(Landroid/arch/lifecycle/d;)V

    return-void
.end method

.method public observeForever(Landroid/arch/lifecycle/m;)V
    .locals 1
    ...
    .line 6
    invoke-virtual {v0, p0}, Landroid/arch/lifecycle/LiveData$b;->y(Z)V
...
.method public removeObserver(Landroid/arch/lifecycle/m;)V
    .locals 1
    .param p1    # Landroid/arch/lifecycle/m;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    .line 3
    :cond_0
    invoke-virtual {p0}, Landroid/arch/lifecycle/LiveData$b;->xa()V
...
.method public removeObservers(Landroid/arch/lifecycle/e;)V
    ...
    invoke-virtual {v2, p1}, Landroid/arch/lifecycle/LiveData$b;->g(Landroid/arch/lifecycle/e;)Z
    ...
    invoke-virtual {p0, v1}, Landroid/arch/lifecycle/LiveData;->removeObserver(Landroid/arch/lifecycle/m;)V
