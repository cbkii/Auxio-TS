...
# static fields
.field static sInstance:Landroid/arch/lifecycle/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/arch/lifecycle/a;->sInstance:Landroid/arch/lifecycle/a;
...
.method constructor <init>()V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/a;->mCallbackMap:Ljava/util/Map;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/a;->Aa:Ljava/util/Map;
...
.method private a(Ljava/lang/Class;[Ljava/lang/reflect/Method;)Landroid/arch/lifecycle/a$a;
    ...
    .line 11
    iget-object v0, v0, Landroid/arch/lifecycle/a$a;->za:Ljava/util/Map;
    ...
    iget-object v5, v5, Landroid/arch/lifecycle/a$a;->za:Ljava/util/Map;
    ...
    .line 18
    :cond_3
    invoke-direct {p0, p1}, Landroid/arch/lifecycle/a;->d(Ljava/lang/Class;)[Ljava/lang/reflect/Method;
    ...
    .line 25
    :goto_4
    invoke-interface {v6}, Landroid/arch/lifecycle/n;->value()Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    .line 36
    iget-object v0, p0, Landroid/arch/lifecycle/a;->mCallbackMap:Ljava/util/Map;

    invoke-interface {v0, p1, p2}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 37
    iget-object p0, p0, Landroid/arch/lifecycle/a;->Aa:Ljava/util/Map;
...
.method private a(Ljava/util/Map;Landroid/arch/lifecycle/a$b;Landroid/arch/lifecycle/Lifecycle$Event;Ljava/lang/Class;)V
    ...
    .line 4
    :cond_0
    iget-object p1, p2, Landroid/arch/lifecycle/a$b;->mMethod:Ljava/lang/reflect/Method;
...
.method b(Ljava/lang/Class;)Z
    ...
    .line 1
    iget-object v0, p0, Landroid/arch/lifecycle/a;->Aa:Ljava/util/Map;
