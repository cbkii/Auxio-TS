...
require_file_contains "app/src/test/java/org/oxycblt/auxio/car/overlay/CarOverlayBoundsClampingTest.kt" "assertEquals(465, x)" "overlay 1280x720 top-center bounds test"
