...
class TopwaySourcePolicyTest {
    ...
    fun testMatchesSystemSourceFilter() {
        ...
        assertTrue(
            TopwaySourcePolicy.matchesSystemSourceFilter("/storage/emulated/0/Download/song.mp3")
        )
        assertTrue(TopwaySourcePolicy.matchesSystemSourceFilter("/mnt/media_rw/USB/Media/song.mp3"))
        assertTrue(
            !TopwaySourcePolicy.matchesSystemSourceFilter("/storage/usbdisk0/DCIM/photo.jpg")
        )
    }
}
